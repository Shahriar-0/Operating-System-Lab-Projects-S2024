...
80100050:	68 80 7e 10 80       	push   $0x80107e80
80100055:	68 c0 c5 10 80       	push   $0x8010c5c0
8010005a:	e8 11 50 00 00       	call   80105070 <initlock>
    bcache.head.next = &bcache.head;
...
801000e8:	e8 03 51 00 00       	call   801051f0 <acquire>
...
801001a3:	68 8e 7e 10 80       	push   $0x80107e8e
...
801001c2:	e8 49 4e 00 00       	call   80105010 <holdingsleep>
...
801001e0:	68 9f 7e 10 80       	push   $0x80107e9f
...
80100203:	e8 08 4e 00 00       	call   80105010 <holdingsleep>
...
80100213:	e8 b8 4d 00 00       	call   80104fd0 <releasesleep>

    acquire(&bcache.lock);
80100218:	c7 04 24 c0 c5 10 80 	movl   $0x8010c5c0,(%esp)
8010021f:	e8 cc 4f 00 00       	call   801051f0 <acquire>
    b->refcnt--;
...
8010026f:	5d                   	pop    %ebp
    release(&bcache.lock);
80100270:	e9 3b 50 00 00       	jmp    801052b0 <release>
        panic("brelse");
80100275:	83 ec 0c             	sub    $0xc,%esp
80100278:	68 a6 7e 10 80       	push   $0x80107ea6
...
801002b1:	e8 3a 4f 00 00       	call   801051f0 <acquire>
...
8010030e:	e8 9d 4f 00 00       	call   801052b0 <release>
                ilock(ip);
80100313:	5a                   	pop    %edx
...
80100365:	e8 46 4f 00 00       	call   801052b0 <release>
    ilock(ip);
8010036a:	58                   	pop    %eax
...
801003b6:	68 ad 7e 10 80       	push   $0x80107ead
...
801003c4:	e8 f7 03 00 00       	call   801007c0 <cprintf>
    cprintf("\n");
801003c9:	c7 04 24 84 86 10 80 	movl   $0x80108684,(%esp)
...
801003dc:	e8 af 4c 00 00       	call   80105090 <getcallerpcs>
    for (i = 0; i < 10; i++)
...
801003ec:	68 c1 7e 10 80       	push   $0x80107ec1
...
8010042a:	e8 41 66 00 00       	call   80106a70 <uartputc>
...
80100515:	e8 56 65 00 00       	call   80106a70 <uartputc>
        uartputc(' ');
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 4a 65 00 00       	call   80106a70 <uartputc>
        uartputc('\b');
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 3e 65 00 00       	call   80106a70 <uartputc>
...
80100561:	e8 3a 4e 00 00       	call   801053a0 <memmove>
        memset(crt + pos, 0, sizeof(crt[0]) * (24 * 80 - pos));
...
80100576:	e8 85 4d 00 00       	call   80105300 <memset>
8010057b:	88 5d e7             	mov    %bl,-0x19(%ebp)
8010057e:	83 c4 10             	add    $0x10,%esp
80100581:	e9 22 ff ff ff       	jmp    801004a8 <consputc.part.0+0x98>
        panic("pos under/overflow");
80100586:	83 ec 0c             	sub    $0xc,%esp
80100589:	68 c5 7e 10 80       	push   $0x80107ec5
...
801005c9:	0f b6 92 48 7f 10 80 	movzbl -0x7fef80b8(%edx),%edx
...
8010076f:	e8 7c 4a 00 00       	call   801051f0 <acquire>
    for (i = 0; i < n; i++)
...
801007a7:	e8 04 4b 00 00       	call   801052b0 <release>
    ilock(ip);
801007ac:	58                   	pop    %eax
...
8010088b:	75 55                	jne    801008e2 <cprintf+0x122>
                s = "(null)";
8010088d:	bb d8 7e 10 80       	mov    $0x80107ed8,%ebx
            for (; *s; s++)
...
801008cd:	e8 1e 49 00 00       	call   801051f0 <acquire>
...
801009e5:	e8 06 48 00 00       	call   801051f0 <acquire>
    while ((c = getc()) >= 0) {
...
80100a1b:	3e ff 24 9d f0 7e 10 	notrack jmp *-0x7fef8110(,%ebx,4)
80100a22:	80 
...
80100a3e:	e8 6d 48 00 00       	call   801052b0 <release>
    if (doprocdump) {
...
8010152a:	68 e8 7e 10 80       	push   $0x80107ee8
8010152f:	68 20 b5 10 80       	push   $0x8010b520
80101534:	e8 37 3b 00 00       	call   80105070 <initlock>
...
801015fa:	75 ce                	jne    801015ca <exec+0x5a>
    if ((pgdir = setupkvm()) == 0)
801015fc:	e8 df 65 00 00       	call   80107be0 <setupkvm>
...
80101663:	e8 98 63 00 00       	call   80107a00 <allocuvm>
...
80101699:	e8 92 62 00 00       	call   80107930 <loaduvm>
...
801016db:	e8 80 64 00 00       	call   80107b60 <freevm>
    if (ip) {
...
80101722:	e8 d9 62 00 00       	call   80107a00 <allocuvm>
...
80101741:	31 ff                	xor    %edi,%edi
    clearpteu(pgdir, (char*)(sz - 2 * PGSIZE));
80101743:	e8 38 65 00 00       	call   80107c80 <clearpteu>
    for (argc = 0; argv[argc]; argc++) {
...
80101793:	e8 68 3d 00 00       	call   80105500 <strlen>
...
801017a6:	e8 55 3d 00 00       	call   80105500 <strlen>
...
801017b7:	e8 24 66 00 00       	call   80107de0 <copyout>
...
801017d1:	e8 8a 63 00 00       	call   80107b60 <freevm>
...
8010181d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
    if (copyout(pgdir, sp, ustack, (3 + argc + 1) * 4) < 0)
80101823:	e8 b8 65 00 00       	call   80107de0 <copyout>
...
80101861:	e8 5a 3c 00 00       	call   801054c0 <safestrcpy>
    curproc->pgdir = pgdir;
...
8010188d:	e8 0e 5f 00 00       	call   801077a0 <switchuvm>
    freevm(oldpgdir);
80101892:	89 3c 24             	mov    %edi,(%esp)
80101895:	e8 c6 62 00 00       	call   80107b60 <freevm>
    return 0;
...
801018ac:	68 59 7f 10 80       	push   $0x80107f59
...
801018da:	68 65 7f 10 80       	push   $0x80107f65
801018df:	68 60 15 11 80       	push   $0x80111560
801018e4:	e8 87 37 00 00       	call   80105070 <initlock>
}
...
80101905:	e8 e6 38 00 00       	call   801051f0 <acquire>
...
80101931:	e8 7a 39 00 00       	call   801052b0 <release>
            return f;
        }
    }
    release(&ftable.lock);
...
8010194a:	e8 61 39 00 00       	call   801052b0 <release>
}
...
80101973:	e8 78 38 00 00       	call   801051f0 <acquire>
    if (f->ref < 1)
...
80101990:	e8 1b 39 00 00       	call   801052b0 <release>
    return f;
}
...
8010199f:	68 6c 7f 10 80       	push   $0x80107f6c
...
801019c5:	e8 26 38 00 00       	call   801051f0 <acquire>
    if (f->ref < 1)
...
801019fd:	89 45 e0             	mov    %eax,-0x20(%ebp)
    release(&ftable.lock);
80101a00:	e8 ab 38 00 00       	call   801052b0 <release>
...
80101a2d:	5d                   	pop    %ebp
        release(&ftable.lock);
80101a2e:	e9 7d 38 00 00       	jmp    801052b0 <release>
...
80101a7c:	68 74 7f 10 80       	push   $0x80107f74
...
80101b6a:	68 7e 7f 10 80       	push   $0x80107f7e
...
80101c53:	68 87 7f 10 80       	push   $0x80107f87
...
80101c89:	68 8d 7f 10 80       	push   $0x80107f8d
...
80101cba:	e8 41 36 00 00       	call   80105300 <memset>
    begin_op();
...
80101d01:	e8 fa 35 00 00       	call   80105300 <memset>
        iupdate(dest);
...
80101db7:	68 97 7f 10 80       	push   $0x80107f97
...
80101e74:	68 aa 7f 10 80       	push   $0x80107faa
...
80101eb5:	e8 46 34 00 00       	call   80105300 <memset>
    log_write(bp);
...
80101efa:	e8 f1 32 00 00       	call   801051f0 <acquire>
    for (ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++) {
...
80101f67:	e8 44 33 00 00       	call   801052b0 <release>
...
80101f92:	89 4b 08             	mov    %ecx,0x8(%ebx)
            release(&icache.lock);
80101f95:	e8 16 33 00 00       	call   801052b0 <release>
            return ip;
...
80101fc2:	68 c0 7f 10 80       	push   $0x80107fc0
...
8010208b:	68 d0 7f 10 80       	push   $0x80107fd0
...
801020c5:	e8 d6 32 00 00       	call   801053a0 <memmove>
    brelse(bp);
...
801020f0:	68 e3 7f 10 80       	push   $0x80107fe3
801020f5:	68 80 1f 11 80       	push   $0x80111f80
801020fa:	e8 71 2f 00 00       	call   80105070 <initlock>
    for (i = 0; i < NINODE; i++) {
801020ff:	83 c4 10             	add    $0x10,%esp
80102102:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        initsleeplock(&icache.inode[i].lock, "inode");
80102108:	83 ec 08             	sub    $0x8,%esp
8010210b:	68 ea 7f 10 80       	push   $0x80107fea
80102110:	53                   	push   %ebx
80102111:	81 c3 90 00 00 00    	add    $0x90,%ebx
80102117:	e8 14 2e 00 00       	call   80104f30 <initsleeplock>
    for (i = 0; i < NINODE; i++) {
...
80102161:	68 50 80 10 80       	push   $0x80108050
...
801021fe:	e8 fd 30 00 00       	call   80105300 <memset>
            dip->type = type;
...
80102233:	68 f0 7f 10 80       	push   $0x80107ff0
...
801022a5:	e8 f6 30 00 00       	call   801053a0 <memmove>
    log_write(bp);
...
801022e3:	e8 08 2f 00 00       	call   801051f0 <acquire>
    ip->ref++;
801022e8:	83 43 08 01          	addl   $0x1,0x8(%ebx)
    release(&icache.lock);
801022ec:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
801022f3:	e8 b8 2f 00 00       	call   801052b0 <release>
}
...
80102326:	e8 45 2c 00 00       	call   80104f70 <acquiresleep>
    if (ip->valid == 0) {
...
80102398:	e8 03 30 00 00       	call   801053a0 <memmove>
        brelse(bp);
...
801023bd:	68 08 80 10 80       	push   $0x80108008
801023c2:	e8 c9 df ff ff       	call   80100390 <panic>
        panic("ilock");
801023c7:	83 ec 0c             	sub    $0xc,%esp
801023ca:	68 02 80 10 80       	push   $0x80108002
...
801023f7:	e8 14 2c 00 00       	call   80105010 <holdingsleep>
...
80102412:	5d                   	pop    %ebp
    releasesleep(&ip->lock);
80102413:	e9 b8 2b 00 00       	jmp    80104fd0 <releasesleep>
        panic("iunlock");
80102418:	83 ec 0c             	sub    $0xc,%esp
8010241b:	68 17 80 10 80       	push   $0x80108017
...
80102444:	e8 27 2b 00 00       	call   80104f70 <acquiresleep>
...
8010245e:	e8 6d 2b 00 00       	call   80104fd0 <releasesleep>
    acquire(&icache.lock);
80102463:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
8010246a:	e8 81 2d 00 00       	call   801051f0 <acquire>
    ip->ref--;
...
801026a7:	e8 f4 2c 00 00       	call   801053a0 <memmove>
        brelse(bp);
...
801027a3:	e8 f8 2b 00 00       	call   801053a0 <memmove>
        log_write(bp);
...
80102842:	e8 c9 2b 00 00       	call   80105410 <strncmp>
}
80102847:	c9                   	leave  
80102848:	c3                   	ret    
...
801028a5:	e8 66 2b 00 00       	call   80105410 <strncmp>
            continue;
...
801028ea:	68 31 80 10 80       	push   $0x80108031
801028ef:	e8 9c da ff ff       	call   80100390 <panic>
        panic("dirlookup not DIR");
801028f4:	83 ec 0c             	sub    $0xc,%esp
801028f7:	68 1f 80 10 80       	push   $0x8010801f
...
8010293c:	e8 af 28 00 00       	call   801051f0 <acquire>
    ip->ref++;
80102941:	83 46 08 01          	addl   $0x1,0x8(%esi)
    release(&icache.lock);
80102945:	c7 04 24 80 1f 11 80 	movl   $0x80111f80,(%esp)
8010294c:	e8 5f 29 00 00       	call   801052b0 <release>
...
801029b7:	e8 e4 29 00 00       	call   801053a0 <memmove>
...
80102a43:	e8 58 29 00 00       	call   801053a0 <memmove>
        name[len] = 0;
...
80102b75:	e8 e6 28 00 00       	call   80105460 <strncpy>
...
80102bb3:	68 40 80 10 80       	push   $0x80108040
80102bb8:	e8 d3 d7 ff ff       	call   80100390 <panic>
        panic("dirlink");
80102bbd:	83 ec 0c             	sub    $0xc,%esp
80102bc0:	68 2e 86 10 80       	push   $0x8010862e
...
80102ccb:	68 ac 80 10 80       	push   $0x801080ac
80102cd0:	e8 bb d6 ff ff       	call   80100390 <panic>
        panic("idestart");
80102cd5:	83 ec 0c             	sub    $0xc,%esp
80102cd8:	68 a3 80 10 80       	push   $0x801080a3
...
80102cfa:	68 be 80 10 80       	push   $0x801080be
80102cff:	68 80 b5 10 80       	push   $0x8010b580
80102d04:	e8 67 23 00 00       	call   80105070 <initlock>
...
80102d92:	e8 59 24 00 00       	call   801051f0 <acquire>
...
80102e0b:	e8 a0 24 00 00       	call   801052b0 <release>
...
80102e32:	e8 d9 21 00 00       	call   80105010 <holdingsleep>
...
80102e6c:	e8 7f 23 00 00       	call   801051f0 <acquire>
...
80102ed5:	c9                   	leave  
    release(&idelock);
80102ed6:	e9 d5 23 00 00       	jmp    801052b0 <release>
...
80102f6e:	68 0c 81 10 80       	push   $0x8010810c
...
80103046:	e8 b5 22 00 00       	call   80105300 <memset>
...
80103080:	e8 6b 21 00 00       	call   801051f0 <acquire>
...
8010309a:	c9                   	leave  
        release(&kmem.lock);
8010309b:	e9 10 22 00 00       	jmp    801052b0 <release>
        panic("kfree");
801030a0:	83 ec 0c             	sub    $0xc,%esp
801030a3:	68 3e 81 10 80       	push   $0x8010813e
...
8010310f:	68 44 81 10 80       	push   $0x80108144
80103114:	68 e0 3b 11 80       	push   $0x80113be0
80103119:	e8 52 1f 00 00       	call   80105070 <initlock>
    p = (char*)PGROUNDUP((uint)vstart);
...
80103203:	e8 e8 1f 00 00       	call   801051f0 <acquire>
    r = kmem.freelist;
...
80103231:	e8 7a 20 00 00       	call   801052b0 <release>
    return (char*)r;
...
8010327f:	0f b6 8a 80 82 10 80 	movzbl -0x7fef7d80(%edx),%ecx
    shift ^= togglecode[data];
80103286:	0f b6 82 80 81 10 80 	movzbl -0x7fef7e80(%edx),%eax
    shift |= shiftcode[data];
...
8010329c:	83 e1 08             	and    $0x8,%ecx
    c = charcode[shift & (CTL | SHIFT)][data];
8010329f:	8b 04 85 60 81 10 80 	mov    -0x7fef7ea0(,%eax,4),%eax
...
801032d8:	31 c0                	xor    %eax,%eax
        shift &= ~(shiftcode[data] | E0ESC);
801032da:	0f b6 8a 80 82 10 80 	movzbl -0x7fef7d80(%edx),%ecx
...
8010365f:	e8 ec 1c 00 00       	call   80105350 <memcmp>
...
80103794:	e8 07 1c 00 00       	call   801053a0 <memmove>
...
8010383e:	68 80 83 10 80       	push   $0x80108380
80103843:	68 20 3c 11 80       	push   $0x80113c20
80103848:	e8 23 18 00 00       	call   80105070 <initlock>
    readsb(dev, &sb);
8010384d:	58                   	pop    %eax
...
801038df:	e8 0c 19 00 00       	call   801051f0 <acquire>
...
80103934:	e8 77 19 00 00       	call   801052b0 <release>
            break;
        }
    }
}
...
80103952:	e8 99 18 00 00       	call   801051f0 <acquire>
    log.outstanding -= 1;
...
80103990:	e8 1b 19 00 00       	call   801052b0 <release>
    }
}
...
801039aa:	e8 41 18 00 00       	call   801051f0 <acquire>
        wakeup(&log);
...
801039cc:	e8 df 18 00 00       	call   801052b0 <release>
...
80103a24:	e8 77 19 00 00       	call   801053a0 <memmove>
...
80103a84:	e8 27 18 00 00       	call   801052b0 <release>
...
80103a97:	68 84 83 10 80       	push   $0x80108384
...
80103af2:	e8 f9 16 00 00       	call   801051f0 <acquire>
    for (i = 0; i < log.lh.n; i++) {
...
80103b34:	c9                   	leave  
    release(&log.lock);
80103b35:	e9 76 17 00 00       	jmp    801052b0 <release>
...
80103b61:	68 93 83 10 80       	push   $0x80108393
80103b66:	e8 25 c8 ff ff       	call   80100390 <panic>
        panic("log_write outside of trans");
80103b6b:	83 ec 0c             	sub    $0xc,%esp
80103b6e:	68 a9 83 10 80       	push   $0x801083a9
...
80103b98:	68 c4 83 10 80       	push   $0x801083c4
80103b9d:	e8 1e cc ff ff       	call   801007c0 <cprintf>
    idtinit();                    // load idt register
80103ba2:	e8 09 2b 00 00       	call   801066b0 <idtinit>
...
80103bc7:	83 ec 08             	sub    $0x8,%esp
    switchkvm();
80103bca:	e8 b1 3b 00 00       	call   80107780 <switchkvm>
    seginit();
80103bcf:	e8 1c 3b 00 00       	call   801076f0 <seginit>
    lapicinit();
...
80103c28:	e8 83 2d 00 00       	call   801069b0 <uartinit>
    pinit();                                    // process table
80103c2d:	e8 1e 08 00 00       	call   80104450 <pinit>
    tvinit();                                   // trap vectors
80103c32:	e8 f9 29 00 00       	call   80106630 <tvinit>
    binit();                                    // buffer cache
...
80103c58:	e8 43 17 00 00       	call   801053a0 <memmove>
...
80103d3e:	68 d8 83 10 80       	push   $0x801083d8
80103d43:	56                   	push   %esi
80103d44:	e8 07 16 00 00       	call   80105350 <memcmp>
...
80103dfa:	68 dd 83 10 80       	push   $0x801083dd
80103dff:	50                   	push   %eax
    conf = (struct mpconf*)P2V((uint)mp->physaddr);
80103e00:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if (memcmp(conf, "PCMP", 4) != 0)
80103e03:	e8 48 15 00 00       	call   80105350 <memcmp>
...
80103f53:	68 e2 83 10 80       	push   $0x801083e2
80103f58:	e8 33 c4 ff ff       	call   80100390 <panic>
        panic("Didn't find a suitable machine");
80103f5d:	83 ec 0c             	sub    $0xc,%esp
80103f60:	68 fc 83 10 80       	push   $0x801083fc
...
80104004:	00 00 00 
    initlock(&p->lock, "pipe");
80104007:	68 1b 84 10 80       	push   $0x8010841b
8010400c:	50                   	push   %eax
8010400d:	e8 5e 10 00 00       	call   80105070 <initlock>
    (*f0)->type = FD_PIPE;
...
801040b3:	e8 38 11 00 00       	call   801051f0 <acquire>
    if (writable) {
...
801040f7:	5d                   	pop    %ebp
        release(&p->lock);
801040f8:	e9 b3 11 00 00       	jmp    801052b0 <release>
...
80104124:	e8 87 11 00 00       	call   801052b0 <release>
        kfree((char*)p);
...
80104151:	e8 9a 10 00 00       	call   801051f0 <acquire>
    for (i = 0; i < n; i++) {
...
801041dc:	e8 cf 10 00 00       	call   801052b0 <release>
                return -1;
...
80104232:	e8 79 10 00 00       	call   801052b0 <release>
    return n;
...
8010425a:	e8 91 0f 00 00       	call   801051f0 <acquire>
...
801042fe:	e8 ad 0f 00 00       	call   801052b0 <release>
    return i;
...
80104319:	e8 92 0f 00 00       	call   801052b0 <release>
            return -1;
...
80104341:	e8 aa 0e 00 00       	call   801051f0 <acquire>
...
8010437c:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
    release(&ptable.lock);
80104382:	e8 29 0f 00 00       	call   801052b0 <release>
...
801043a4:	89 53 18             	mov    %edx,0x18(%ebx)
    *(uint*)sp = (uint)trapret;
801043a7:	c7 40 14 17 66 10 80 	movl   $0x80106617,0x14(%eax)
    p->context = (struct context*)sp;
...
801043b6:	e8 45 0f 00 00       	call   80105300 <memset>
...
801043da:	e8 d1 0e 00 00       	call   801052b0 <release>
}
...
8010440f:	e8 9c 0e 00 00       	call   801052b0 <release>
...
8010445a:	68 20 84 10 80       	push   $0x80108420
8010445f:	68 c0 42 11 80       	push   $0x801142c0
80104464:	e8 07 0c 00 00       	call   80105070 <initlock>
}
...
80104508:	83 ec 04             	sub    $0x4,%esp
    pushcli();
8010450b:	e8 e0 0b 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104510:	e8 5b ff ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104515:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
8010451b:	e8 20 0c 00 00       	call   80105140 <popcli>
}
...
80104547:	e8 94 36 00 00       	call   80107be0 <setupkvm>
...
80104565:	e8 46 33 00 00       	call   801078b0 <inituvm>
...
8010457a:	e8 81 0d 00 00       	call   80105300 <memset>
...
801045d3:	68 50 84 10 80       	push   $0x80108450
801045d8:	50                   	push   %eax
801045d9:	e8 e2 0e 00 00       	call   801054c0 <safestrcpy>
    p->cwd = namei("/");
801045de:	c7 04 24 59 84 10 80 	movl   $0x80108459,(%esp)
...
80104617:	68 37 84 10 80       	push   $0x80108437
...
80104639:	8b 75 08             	mov    0x8(%ebp),%esi
    pushcli();
8010463c:	e8 af 0a 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104641:	e8 2a fe ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104646:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
8010464c:	e8 ef 0a 00 00       	call   80105140 <popcli>
    sz = curproc->sz;
...
8010465f:	e8 3c 31 00 00       	call   801077a0 <switchuvm>
    return 0;
...
8010467a:	e8 81 33 00 00       	call   80107a00 <allocuvm>
...
8010469a:	e8 91 34 00 00       	call   80107b30 <deallocuvm>
...
801046ba:	83 ec 1c             	sub    $0x1c,%esp
    pushcli();
801046bd:	e8 2e 0a 00 00       	call   801050f0 <pushcli>
    c = mycpu();
801046c2:	e8 a9 fd ff ff       	call   80104470 <mycpu>
    p = c->proc;
801046c7:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
801046cd:	e8 6e 0a 00 00       	call   80105140 <popcli>
    if ((np = allocproc()) == 0) {
...
801046ec:	e8 bf 35 00 00       	call   80107cb0 <copyuvm>
...
80104816:	e8 d5 09 00 00       	call   801051f0 <acquire>
...
80104830:	e8 6b 2f 00 00       	call   801077a0 <switchuvm>
...
8010483b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
            swtch(&(c->scheduler), p->context);
80104842:	e8 dc 0c 00 00       	call   80105523 <swtch>
            switchkvm();
80104847:	e8 34 2f 00 00       	call   80107780 <switchkvm>
            c->proc = 0;
...
8010486c:	e8 3f 0a 00 00       	call   801052b0 <release>
        sti();
...
801048e7:	e8 37 0c 00 00       	call   80105523 <swtch>
    mycpu()->intena = intena;
...
8010494a:	83 ec 0c             	sub    $0xc,%esp
    pushcli();
8010494d:	e8 9e 07 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104952:	e8 19 fb ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104957:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
    popcli();
8010495d:	e8 de 07 00 00       	call   80105140 <popcli>
    if (curproc == initproc)
...
801049ba:	e8 31 08 00 00       	call   801051f0 <acquire>
...
80104a5d:	68 a8 84 10 80       	push   $0x801084a8
80104a62:	e8 29 b9 ff ff       	call   80100390 <panic>
        panic("init exiting");
80104a67:	83 ec 0c             	sub    $0xc,%esp
80104a6a:	68 9b 84 10 80       	push   $0x8010849b
...
80104a90:	e8 5b 07 00 00       	call   801051f0 <acquire>
    pushcli();
80104a95:	e8 56 06 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104a9a:	e8 d1 f9 ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104a9f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80104aa5:	e8 96 06 00 00       	call   80105140 <popcli>
...
80104abd:	e8 ee 07 00 00       	call   801052b0 <release>
}
...
80104ae0:	8b 75 0c             	mov    0xc(%ebp),%esi
    pushcli();
80104ae3:	e8 08 06 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104ae8:	e8 83 f9 ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104aed:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80104af3:	e8 48 06 00 00       	call   80105140 <popcli>
    if (p == 0)
...
80104b14:	e8 d7 06 00 00       	call   801051f0 <acquire>
        release(lk);
80104b19:	89 34 24             	mov    %esi,(%esp)
80104b1c:	e8 8f 07 00 00       	call   801052b0 <release>
    p->chan = chan;
...
80104b3e:	e8 6d 07 00 00       	call   801052b0 <release>
        acquire(lk);
...
80104b4f:	5d                   	pop    %ebp
        acquire(lk);
80104b50:	e9 9b 06 00 00       	jmp    801051f0 <acquire>
...
80104b79:	68 ba 84 10 80       	push   $0x801084ba
80104b7e:	e8 0d b8 ff ff       	call   80100390 <panic>
        panic("sleep");
80104b83:	83 ec 0c             	sub    $0xc,%esp
80104b86:	68 b4 84 10 80       	push   $0x801084b4
...
80104c2a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
                freevm(p->pgdir);
80104c31:	e8 2a 2f 00 00       	call   80107b60 <freevm>
                release(&ptable.lock);
...
80104c56:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
                release(&ptable.lock);
80104c5d:	e8 4e 06 00 00       	call   801052b0 <release>
                return pid;
...
80104c7b:	e8 30 06 00 00       	call   801052b0 <release>
            return -1;
...
80104ca3:	e8 48 05 00 00       	call   801051f0 <acquire>
...
80104ce8:	c9                   	leave  
    release(&ptable.lock);
80104ce9:	e9 c2 05 00 00       	jmp    801052b0 <release>
...
80104d03:	e8 e8 04 00 00       	call   801051f0 <acquire>
...
80104d43:	e8 68 05 00 00       	call   801052b0 <release>
            return 0;
        }
    }
    release(&ptable.lock);
...
80104d60:	e8 4b 05 00 00       	call   801052b0 <release>
}
...
80104da3:	68 84 86 10 80       	push   $0x80108684
...
80104dc4:	74 ea                	je     80104db0 <procdump+0x30>
            state = "???";
80104dc6:	ba cb 84 10 80       	mov    $0x801084cb,%edx
        if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104dcb:	83 f8 05             	cmp    $0x5,%eax
80104dce:	77 11                	ja     80104de1 <procdump+0x61>
80104dd0:	8b 14 85 2c 85 10 80 	mov    -0x7fef7ad4(,%eax,4),%edx
            state = "???";
80104dd7:	b8 cb 84 10 80       	mov    $0x801084cb,%eax
...
80104de6:	68 cf 84 10 80       	push   $0x801084cf
...
80104e0d:	e8 7e 02 00 00       	call   80105090 <getcallerpcs>
            for (i = 0; i < 10 && pc[i] != 0; i++)
...
80104e25:	68 c1 7e 10 80       	push   $0x80107ec1
...
80104e58:	83 ec 04             	sub    $0x4,%esp
    pushcli();
80104e5b:	e8 90 02 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104e60:	e8 0b f6 ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104e65:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80104e6b:	e8 d0 02 00 00       	call   80105140 <popcli>
...
80104ea8:	83 ec 04             	sub    $0x4,%esp
    pushcli();
80104eab:	e8 40 02 00 00       	call   801050f0 <pushcli>
    c = mycpu();
80104eb0:	e8 bb f5 ff ff       	call   80104470 <mycpu>
    p = c->proc;
80104eb5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
    popcli();
80104ebb:	e8 80 02 00 00       	call   80105140 <popcli>
    struct proc* current_proc = myproc();
...
80104eda:	8b 5d 08             	mov    0x8(%ebp),%ebx
    while(n > 9) {
80104edd:	83 fb 09             	cmp    $0x9,%ebx
80104ee0:	7e 3d                	jle    80104f1f <droot+0x4f>
        int sum_digits = 0;
        int temp = n;
        while(temp > 0) {
            sum_digits += temp % 10;
80104ee2:	be 67 66 66 66       	mov    $0x66666667,%esi
80104ee7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104eee:	66 90                	xchg   %ax,%ax
int droot(int n) {
80104ef0:	89 d9                	mov    %ebx,%ecx
        int sum_digits = 0;
80104ef2:	31 db                	xor    %ebx,%ebx
80104ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            sum_digits += temp % 10;
80104ef8:	89 c8                	mov    %ecx,%eax
80104efa:	89 cf                	mov    %ecx,%edi
80104efc:	f7 ee                	imul   %esi
80104efe:	89 c8                	mov    %ecx,%eax
80104f00:	c1 f8 1f             	sar    $0x1f,%eax
80104f03:	c1 fa 02             	sar    $0x2,%edx
80104f06:	29 c2                	sub    %eax,%edx
80104f08:	8d 04 92             	lea    (%edx,%edx,4),%eax
80104f0b:	01 c0                	add    %eax,%eax
80104f0d:	29 c7                	sub    %eax,%edi
80104f0f:	89 c8                	mov    %ecx,%eax
            temp /= 10;
80104f11:	89 d1                	mov    %edx,%ecx
            sum_digits += temp % 10;
80104f13:	01 fb                	add    %edi,%ebx
        while(temp > 0) {
80104f15:	83 f8 09             	cmp    $0x9,%eax
80104f18:	7f de                	jg     80104ef8 <droot+0x28>
    while(n > 9) {
80104f1a:	83 fb 09             	cmp    $0x9,%ebx
80104f1d:	7f d1                	jg     80104ef0 <droot+0x20>
        }
        n = sum_digits;
    }
    return n;
}
80104f1f:	89 d8                	mov    %ebx,%eax
80104f21:	5b                   	pop    %ebx
80104f22:	5e                   	pop    %esi
80104f23:	5f                   	pop    %edi
80104f24:	5d                   	pop    %ebp
...
80104f3e:	68 44 85 10 80       	push   $0x80108544
80104f43:	8d 43 04             	lea    0x4(%ebx),%eax
80104f46:	50                   	push   %eax
80104f47:	e8 24 01 00 00       	call   80105070 <initlock>
    lk->name = name;
80104f4c:	8b 45 0c             	mov    0xc(%ebp),%eax
    lk->locked = 0;
80104f4f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    lk->pid = 0;
}
80104f55:	83 c4 10             	add    $0x10,%esp
    lk->pid = 0;
80104f58:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
    lk->name = name;
80104f5f:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
80104f83:	e8 68 02 00 00       	call   801051f0 <acquire>
    while (lk->locked) {
80104f88:	8b 13                	mov    (%ebx),%edx
80104f8a:	83 c4 10             	add    $0x10,%esp
80104f8d:	85 d2                	test   %edx,%edx
80104f8f:	74 1a                	je     80104fab <acquiresleep+0x3b>
80104f91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        sleep(lk, &lk->lk);
80104f98:	83 ec 08             	sub    $0x8,%esp
80104f9b:	56                   	push   %esi
80104f9c:	53                   	push   %ebx
80104f9d:	e8 2e fb ff ff       	call   80104ad0 <sleep>
    while (lk->locked) {
80104fa2:	8b 03                	mov    (%ebx),%eax
80104fa4:	83 c4 10             	add    $0x10,%esp
80104fa7:	85 c0                	test   %eax,%eax
80104fa9:	75 ed                	jne    80104f98 <acquiresleep+0x28>
    }
    lk->locked = 1;
80104fab:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    lk->pid = myproc()->pid;
80104fb1:	e8 4a f5 ff ff       	call   80104500 <myproc>
80104fb6:	8b 40 10             	mov    0x10(%eax),%eax
80104fb9:	89 43 3c             	mov    %eax,0x3c(%ebx)
    release(&lk->lk);
80104fbc:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80104fc4:	5d                   	pop    %ebp
    release(&lk->lk);
80104fc5:	e9 e6 02 00 00       	jmp    801052b0 <release>
...
80104fd9:	8b 5d 08             	mov    0x8(%ebp),%ebx
    acquire(&lk->lk);
80104fdc:	8d 73 04             	lea    0x4(%ebx),%esi
80104fdf:	83 ec 0c             	sub    $0xc,%esp
80104fe2:	56                   	push   %esi
80104fe3:	e8 08 02 00 00       	call   801051f0 <acquire>
    lk->locked = 0;
80104fe8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    lk->pid = 0;
80104fee:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
    wakeup(lk);
80104ff5:	89 1c 24             	mov    %ebx,(%esp)
80104ff8:	e8 93 fc ff ff       	call   80104c90 <wakeup>
    release(&lk->lk);
80104ffd:	89 75 08             	mov    %esi,0x8(%ebp)
...
80105008:	5d                   	pop    %ebp
    release(&lk->lk);
80105009:	e9 a2 02 00 00       	jmp    801052b0 <release>
...
8010501f:	8b 5d 08             	mov    0x8(%ebp),%ebx
    ...
    acquire(&lk->lk);
80105022:	8d 73 04             	lea    0x4(%ebx),%esi
80105025:	56                   	push   %esi
80105026:	e8 c5 01 00 00       	call   801051f0 <acquire>
    r = lk->locked && (lk->pid == myproc()->pid);
8010502b:	8b 03                	mov    (%ebx),%eax
8010502d:	83 c4 10             	add    $0x10,%esp
80105030:	85 c0                	test   %eax,%eax
80105032:	75 1c                	jne    80105050 <holdingsleep+0x40>
    release(&lk->lk);
80105034:	83 ec 0c             	sub    $0xc,%esp
80105037:	56                   	push   %esi
80105038:	e8 73 02 00 00       	call   801052b0 <release>
    return r;
}
8010503d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105040:	89 f8                	mov    %edi,%eax
80105042:	5b                   	pop    %ebx
80105043:	5e                   	pop    %esi
80105044:	5f                   	pop    %edi
80105045:	5d                   	pop    %ebp
...
8010504e:	66 90                	xchg   %ax,%ax
    r = lk->locked && (lk->pid == myproc()->pid);
80105050:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80105053:	e8 a8 f4 ff ff       	call   80104500 <myproc>
80105058:	39 58 10             	cmp    %ebx,0x10(%eax)
8010505b:	0f 94 c0             	sete   %al
8010505e:	0f b6 c0             	movzbl %al,%eax
80105061:	89 c7                	mov    %eax,%edi
80105063:	eb cf                	jmp    80105034 <holdingsleep+0x24>
...
80105077:	8b 45 08             	mov    0x8(%ebp),%eax
    lk->name = name;
8010507a:	8b 55 0c             	mov    0xc(%ebp),%edx
    lk->locked = 0;
8010507d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    lk->name = name;
80105083:	89 50 04             	mov    %edx,0x4(%eax)
    lk->cpu = 0;
...
void getcallerpcs(void* v, uint pcs[]) {
8010509d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    ebp = (uint*)v - 2;
801050a0:	83 e8 08             	sub    $0x8,%eax
    for (i = 0; i < 10; i++) {
801050a3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801050a7:	90                   	nop
        if (ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801050a8:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
801050ae:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801050b4:	77 1a                	ja     801050d0 <getcallerpcs+0x40>
            break;
        pcs[i] = ebp[1];     // saved %eip
801050b6:	8b 58 04             	mov    0x4(%eax),%ebx
801050b9:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
    for (i = 0; i < 10; i++) {
801050bc:	83 c2 01             	add    $0x1,%edx
        ebp = (uint*)ebp[0]; // saved %ebp
801050bf:	8b 00                	mov    (%eax),%eax
    for (i = 0; i < 10; i++) {
801050c1:	83 fa 0a             	cmp    $0xa,%edx
801050c4:	75 e2                	jne    801050a8 <getcallerpcs+0x18>
    }
    for (; i < 10; i++)
        pcs[i] = 0;
}
...
801050c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for (; i < 10; i++)
801050d0:	8d 04 91             	lea    (%ecx,%edx,4),%eax
801050d3:	8d 51 28             	lea    0x28(%ecx),%edx
...
801050e9:	39 d0                	cmp    %edx,%eax
801050eb:	75 f3                	jne    801050e0 <getcallerpcs+0x50>
}
801050ed:	5b                   	pop    %ebx
801050ee:	5d                   	pop    %ebp
801050ef:	c3                   	ret    
...
801050fd:	fa                   	cli    
    ...
    cli();
    if (mycpu()->ncli == 0)
801050fe:	e8 6d f3 ff ff       	call   80104470 <mycpu>
80105103:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105109:	85 c0                	test   %eax,%eax
8010510b:	74 13                	je     80105120 <pushcli+0x30>
        mycpu()->intena = eflags & FL_IF;
    mycpu()->ncli += 1;
8010510d:	e8 5e f3 ff ff       	call   80104470 <mycpu>
80105112:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010511f:	90                   	nop
        mycpu()->intena = eflags & FL_IF;
80105120:	e8 4b f3 ff ff       	call   80104470 <mycpu>
80105125:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010512b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80105131:	eb da                	jmp    8010510d <pushcli+0x1d>
...
8010514b:	58                   	pop    %eax
    if (readeflags() & FL_IF)
8010514c:	f6 c4 02             	test   $0x2,%ah
8010514f:	75 31                	jne    80105182 <popcli+0x42>
        panic("popcli - interruptible");
    if (--mycpu()->ncli < 0)
80105151:	e8 1a f3 ff ff       	call   80104470 <mycpu>
80105156:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
8010515d:	78 30                	js     8010518f <popcli+0x4f>
        panic("popcli");
    if (mycpu()->ncli == 0 && mycpu()->intena)
8010515f:	e8 0c f3 ff ff       	call   80104470 <mycpu>
80105164:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010516a:	85 d2                	test   %edx,%edx
8010516c:	74 02                	je     80105170 <popcli+0x30>
        sti();
}
8010516e:	c9                   	leave  
8010516f:	c3                   	ret    
    if (mycpu()->ncli == 0 && mycpu()->intena)
80105170:	e8 fb f2 ff ff       	call   80104470 <mycpu>
80105175:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010517b:	85 c0                	test   %eax,%eax
8010517d:	74 ef                	je     8010516e <popcli+0x2e>
    asm volatile("sti");
8010517f:	fb                   	sti    
}
80105180:	c9                   	leave  
...
80105185:	68 4f 85 10 80       	push   $0x8010854f
8010518a:	e8 01 b2 ff ff       	call   80100390 <panic>
        panic("popcli");
8010518f:	83 ec 0c             	sub    $0xc,%esp
80105192:	68 66 85 10 80       	push   $0x80108566
...
801051ac:	31 db                	xor    %ebx,%ebx
    pushcli();
801051ae:	e8 3d ff ff ff       	call   801050f0 <pushcli>
    r = lock->locked && lock->cpu == mycpu();
801051b3:	8b 06                	mov    (%esi),%eax
801051b5:	85 c0                	test   %eax,%eax
801051b7:	75 0f                	jne    801051c8 <holding+0x28>
    popcli();
801051b9:	e8 82 ff ff ff       	call   80105140 <popcli>
}
...
801051c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    r = lock->locked && lock->cpu == mycpu();
801051c8:	8b 5e 08             	mov    0x8(%esi),%ebx
801051cb:	e8 a0 f2 ff ff       	call   80104470 <mycpu>
801051d0:	39 c3                	cmp    %eax,%ebx
801051d2:	0f 94 c3             	sete   %bl
    popcli();
801051d5:	e8 66 ff ff ff       	call   80105140 <popcli>
    r = lock->locked && lock->cpu == mycpu();
801051da:	0f b6 db             	movzbl %bl,%ebx
}
...
80105234:	e8 37 f2 ff ff       	call   80104470 <mycpu>
80105239:	89 43 08             	mov    %eax,0x8(%ebx)
    ebp = (uint*)v - 2;
8010523c:	89 e8                	mov    %ebp,%eax
8010523e:	66 90                	xchg   %ax,%ax
        if (ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105240:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80105246:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
8010524c:	77 22                	ja     80105270 <acquire+0x80>
        pcs[i] = ebp[1];     // saved %eip
8010524e:	8b 50 04             	mov    0x4(%eax),%edx
80105251:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
    for (i = 0; i < 10; i++) {
80105255:	83 c6 01             	add    $0x1,%esi
        ebp = (uint*)ebp[0]; // saved %ebp
80105258:	8b 00                	mov    (%eax),%eax
    for (i = 0; i < 10; i++) {
8010525a:	83 fe 0a             	cmp    $0xa,%esi
8010525d:	75 e1                	jne    80105240 <acquire+0x50>
}
...
8010526d:	8d 76 00             	lea    0x0(%esi),%esi
    for (; i < 10; i++)
80105270:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
80105274:	83 c3 34             	add    $0x34,%ebx
...
80105297:	68 6d 85 10 80       	push   $0x8010856d
...
801052bf:	e8 dc fe ff ff       	call   801051a0 <holding>
801052c4:	83 c4 10             	add    $0x10,%esp
801052c7:	85 c0                	test   %eax,%eax
801052c9:	74 22                	je     801052ed <release+0x3d>
    lk->pcs[0] = 0;
801052cb:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    lk->cpu = 0;
801052d2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    __sync_synchronize();
801052d9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0"
801052de:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801052e4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801052e7:	c9                   	leave  
    popcli();
801052e8:	e9 53 fe ff ff       	jmp    80105140 <popcli>
        panic("release");
801052ed:	83 ec 0c             	sub    $0xc,%esp
801052f0:	68 75 85 10 80       	push   $0x80108575
...
80105312:	89 d7                	mov    %edx,%edi
80105314:	09 cf                	or     %ecx,%edi
80105316:	83 e7 03             	and    $0x3,%edi
80105319:	75 25                	jne    80105340 <memset+0x40>
        c &= 0xFF;
8010531b:	0f b6 f8             	movzbl %al,%edi
        stosl(dst, (c << 24) | (c << 16) | (c << 8) | c, n / 4);
8010531e:	c1 e0 18             	shl    $0x18,%eax
80105321:	89 fb                	mov    %edi,%ebx
80105323:	c1 e9 02             	shr    $0x2,%ecx
80105326:	c1 e3 10             	shl    $0x10,%ebx
80105329:	09 d8                	or     %ebx,%eax
8010532b:	09 f8                	or     %edi,%eax
8010532d:	c1 e7 08             	shl    $0x8,%edi
80105330:	09 f8                	or     %edi,%eax
    asm volatile("cld; rep stosl"
80105332:	89 d7                	mov    %edx,%edi
80105334:	fc                   	cld    
80105335:	f3 ab                	rep stos %eax,%es:(%edi)
    }
    else
        stosb(dst, c, n);
    return dst;
...
80105340:	89 d7                	mov    %edx,%edi
80105342:	fc                   	cld    
80105343:	f3 aa                	rep stos %al,%es:(%edi)
80105345:	5b                   	pop    %ebx
...
80105358:	8b 75 10             	mov    0x10(%ebp),%esi
...
8010535f:	8b 45 0c             	mov    0xc(%ebp),%eax
    ...
    s2 = v2;
    while (n-- > 0) {
80105362:	85 f6                	test   %esi,%esi
80105364:	74 2a                	je     80105390 <memcmp+0x40>
80105366:	01 c6                	add    %eax,%esi
80105368:	eb 10                	jmp    8010537a <memcmp+0x2a>
8010536a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if (*s1 != *s2)
            return *s1 - *s2;
        s1++, s2++;
80105370:	83 c0 01             	add    $0x1,%eax
80105373:	83 c2 01             	add    $0x1,%edx
    while (n-- > 0) {
80105376:	39 f0                	cmp    %esi,%eax
80105378:	74 16                	je     80105390 <memcmp+0x40>
        if (*s1 != *s2)
8010537a:	0f b6 0a             	movzbl (%edx),%ecx
8010537d:	0f b6 18             	movzbl (%eax),%ebx
80105380:	38 d9                	cmp    %bl,%cl
80105382:	74 ec                	je     80105370 <memcmp+0x20>
            return *s1 - *s2;
80105384:	0f b6 c1             	movzbl %cl,%eax
80105387:	29 d8                	sub    %ebx,%eax
    }
...
801053a8:	8b 55 08             	mov    0x8(%ebp),%edx
801053ab:	8b 4d 10             	mov    0x10(%ebp),%ecx
801053ae:	56                   	push   %esi
801053af:	8b 75 0c             	mov    0xc(%ebp),%esi
    const char* s;
    char* d;
    ...
    d = dst;
    if (s < d && s + n > d) {
801053b2:	39 d6                	cmp    %edx,%esi
801053b4:	73 2a                	jae    801053e0 <memmove+0x40>
801053b6:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
801053b9:	39 fa                	cmp    %edi,%edx
801053bb:	73 23                	jae    801053e0 <memmove+0x40>
801053bd:	8d 41 ff             	lea    -0x1(%ecx),%eax
        s += n;
        d += n;
        while (n-- > 0)
801053c0:	85 c9                	test   %ecx,%ecx
801053c2:	74 13                	je     801053d7 <memmove+0x37>
801053c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            *--d = *--s;
801053c8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801053cc:	88 0c 02             	mov    %cl,(%edx,%eax,1)
        while (n-- > 0)
801053cf:	83 e8 01             	sub    $0x1,%eax
801053d2:	83 f8 ff             	cmp    $0xffffffff,%eax
801053d5:	75 f1                	jne    801053c8 <memmove+0x28>
    else
        while (n-- > 0)
            *d++ = *s++;
...
801053d7:	5e                   	pop    %esi
801053d8:	89 d0                	mov    %edx,%eax
801053da:	5f                   	pop    %edi
801053db:	5d                   	pop    %ebp
801053dc:	c3                   	ret    
801053dd:	8d 76 00             	lea    0x0(%esi),%esi
        while (n-- > 0)
801053e0:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
801053e3:	89 d7                	mov    %edx,%edi
801053e5:	85 c9                	test   %ecx,%ecx
801053e7:	74 ee                	je     801053d7 <memmove+0x37>
801053e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            *d++ = *s++;
801053f0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
        while (n-- > 0)
801053f1:	39 f0                	cmp    %esi,%eax
801053f3:	75 fb                	jne    801053f0 <memmove+0x50>
}
801053f5:	5e                   	pop    %esi
801053f6:	89 d0                	mov    %edx,%eax
801053f8:	5f                   	pop    %edi
801053f9:	5d                   	pop    %ebp
801053fa:	c3                   	ret    
...
80105404:	eb 9a                	jmp    801053a0 <memmove>
...
80105418:	8b 75 10             	mov    0x10(%ebp),%esi
8010541b:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010541e:	53                   	push   %ebx
8010541f:	8b 45 0c             	mov    0xc(%ebp),%eax
    while (n > 0 && *p && *p == *q)
80105422:	85 f6                	test   %esi,%esi
80105424:	74 32                	je     80105458 <strncmp+0x48>
80105426:	01 c6                	add    %eax,%esi
80105428:	eb 14                	jmp    8010543e <strncmp+0x2e>
8010542a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105430:	38 da                	cmp    %bl,%dl
80105432:	75 14                	jne    80105448 <strncmp+0x38>
        n--, p++, q++;
80105434:	83 c0 01             	add    $0x1,%eax
80105437:	83 c1 01             	add    $0x1,%ecx
    while (n > 0 && *p && *p == *q)
8010543a:	39 f0                	cmp    %esi,%eax
8010543c:	74 1a                	je     80105458 <strncmp+0x48>
8010543e:	0f b6 11             	movzbl (%ecx),%edx
80105441:	0f b6 18             	movzbl (%eax),%ebx
80105444:	84 d2                	test   %dl,%dl
80105446:	75 e8                	jne    80105430 <strncmp+0x20>
    if (n == 0)
        return 0;
    return (uchar)*p - (uchar)*q;
80105448:	0f b6 c2             	movzbl %dl,%eax
8010544b:	29 d8                	sub    %ebx,%eax
}
8010544d:	5b                   	pop    %ebx
8010544e:	5e                   	pop    %esi
8010544f:	5d                   	pop    %ebp
...
8010546d:	8b 45 10             	mov    0x10(%ebp),%eax
    ...
    os = s;
    while (n-- > 0 && (*s++ = *t++) != 0)
80105470:	89 f2                	mov    %esi,%edx
80105472:	eb 1b                	jmp    8010548f <strncpy+0x2f>
80105474:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105478:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010547c:	8b 7d 0c             	mov    0xc(%ebp),%edi
8010547f:	83 c2 01             	add    $0x1,%edx
80105482:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80105486:	89 f9                	mov    %edi,%ecx
80105488:	88 4a ff             	mov    %cl,-0x1(%edx)
8010548b:	84 c9                	test   %cl,%cl
8010548d:	74 09                	je     80105498 <strncpy+0x38>
8010548f:	89 c3                	mov    %eax,%ebx
80105491:	83 e8 01             	sub    $0x1,%eax
80105494:	85 db                	test   %ebx,%ebx
80105496:	7f e0                	jg     80105478 <strncpy+0x18>
        ;
    while (n-- > 0)
80105498:	89 d1                	mov    %edx,%ecx
8010549a:	85 c0                	test   %eax,%eax
8010549c:	7e 15                	jle    801054b3 <strncpy+0x53>
8010549e:	66 90                	xchg   %ax,%ax
        *s++ = 0;
801054a0:	83 c1 01             	add    $0x1,%ecx
801054a3:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
    while (n-- > 0)
801054a7:	89 c8                	mov    %ecx,%eax
801054a9:	f7 d0                	not    %eax
801054ab:	01 d0                	add    %edx,%eax
801054ad:	01 d8                	add    %ebx,%eax
801054af:	85 c0                	test   %eax,%eax
801054b1:	7f ed                	jg     801054a0 <strncpy+0x40>
    return os;
}
801054b3:	5b                   	pop    %ebx
801054b4:	89 f0                	mov    %esi,%eax
801054b6:	5e                   	pop    %esi
801054b7:	5f                   	pop    %edi
801054b8:	5d                   	pop    %ebp
801054b9:	c3                   	ret    
...
801054cb:	8b 75 08             	mov    0x8(%ebp),%esi
...
801054d4:	7e 21                	jle    801054f7 <safestrcpy+0x37>
801054d6:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801054da:	89 f2                	mov    %esi,%edx
801054dc:	eb 12                	jmp    801054f0 <safestrcpy+0x30>
801054de:	66 90                	xchg   %ax,%ax
        return os;
    while (--n > 0 && (*s++ = *t++) != 0)
801054e0:	0f b6 08             	movzbl (%eax),%ecx
801054e3:	83 c0 01             	add    $0x1,%eax
801054e6:	83 c2 01             	add    $0x1,%edx
801054e9:	88 4a ff             	mov    %cl,-0x1(%edx)
801054ec:	84 c9                	test   %cl,%cl
801054ee:	74 04                	je     801054f4 <safestrcpy+0x34>
801054f0:	39 d8                	cmp    %ebx,%eax
801054f2:	75 ec                	jne    801054e0 <safestrcpy+0x20>
        ;
    *s = 0;
801054f4:	c6 02 00             	movb   $0x0,(%edx)
    return os;
}
801054f7:	89 f0                	mov    %esi,%eax
801054f9:	5b                   	pop    %ebx
801054fa:	5e                   	pop    %esi
801054fb:	5d                   	pop    %ebp
801054fc:	c3                   	ret    
...
80105509:	8b 55 08             	mov    0x8(%ebp),%edx
    for (n = 0; s[n]; n++)
8010550c:	80 3a 00             	cmpb   $0x0,(%edx)
8010550f:	74 10                	je     80105521 <strlen+0x21>
80105511:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105518:	83 c0 01             	add    $0x1,%eax
8010551b:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
8010551f:	75 f7                	jne    80105518 <strlen+0x18>
        ;
    return n;
}
80105521:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80105523:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105527:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010552e:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
8010552f:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105531:	89 d4                	mov    %edx,%esp
...
8010554b:	8b 5d 08             	mov    0x8(%ebp),%ebx
    struct proc* curproc = myproc();
8010554e:	e8 ad ef ff ff       	call   80104500 <myproc>

    if (addr >= curproc->sz || addr + 4 > curproc->sz)
80105553:	8b 00                	mov    (%eax),%eax
80105555:	39 d8                	cmp    %ebx,%eax
80105557:	76 17                	jbe    80105570 <fetchint+0x30>
80105559:	8d 53 04             	lea    0x4(%ebx),%edx
8010555c:	39 d0                	cmp    %edx,%eax
8010555e:	72 10                	jb     80105570 <fetchint+0x30>
        return -1;
    *ip = *(int*)(addr);
80105560:	8b 45 0c             	mov    0xc(%ebp),%eax
80105563:	8b 13                	mov    (%ebx),%edx
80105565:	89 10                	mov    %edx,(%eax)
    return 0;
80105567:	31 c0                	xor    %eax,%eax
}
80105569:	83 c4 04             	add    $0x4,%esp
8010556c:	5b                   	pop    %ebx
8010556d:	5d                   	pop    %ebp
8010556e:	c3                   	ret    
8010556f:	90                   	nop
...
80105575:	eb f2                	jmp    80105569 <fetchint+0x29>
...
8010558b:	8b 5d 08             	mov    0x8(%ebp),%ebx
    char *s, *ep;
    struct proc* curproc = myproc();
8010558e:	e8 6d ef ff ff       	call   80104500 <myproc>

    if (addr >= curproc->sz)
80105593:	39 18                	cmp    %ebx,(%eax)
80105595:	76 31                	jbe    801055c8 <fetchstr+0x48>
        return -1;
    *pp = (char*)addr;
...
801055a0:	73 26                	jae    801055c8 <fetchstr+0x48>
801055a2:	89 d8                	mov    %ebx,%eax
801055a4:	eb 11                	jmp    801055b7 <fetchstr+0x37>
...
801055b5:	76 11                	jbe    801055c8 <fetchstr+0x48>
        if (*s == 0)
801055b7:	80 38 00             	cmpb   $0x0,(%eax)
801055ba:	75 f4                	jne    801055b0 <fetchstr+0x30>
            return s - *pp;
    }
    return -1;
}
801055bc:	83 c4 04             	add    $0x4,%esp
            return s - *pp;
801055bf:	29 d8                	sub    %ebx,%eax
}
801055c1:	5b                   	pop    %ebx
801055c2:	5d                   	pop    %ebp
801055c3:	c3                   	ret    
801055c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801055c8:	83 c4 04             	add    $0x4,%esp
        return -1;
...
801055e9:	e8 12 ef ff ff       	call   80104500 <myproc>
801055ee:	8b 55 08             	mov    0x8(%ebp),%edx
801055f1:	8b 40 18             	mov    0x18(%eax),%eax
801055f4:	8b 40 44             	mov    0x44(%eax),%eax
801055f7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
    struct proc* curproc = myproc();
801055fa:	e8 01 ef ff ff       	call   80104500 <myproc>
    return fetchint((myproc()->tf->esp) + 4 + 4 * n, ip);
801055ff:	8d 73 04             	lea    0x4(%ebx),%esi
    if (addr >= curproc->sz || addr + 4 > curproc->sz)
80105602:	8b 00                	mov    (%eax),%eax
80105604:	39 c6                	cmp    %eax,%esi
80105606:	73 18                	jae    80105620 <argint+0x40>
80105608:	8d 53 08             	lea    0x8(%ebx),%edx
8010560b:	39 d0                	cmp    %edx,%eax
8010560d:	72 11                	jb     80105620 <argint+0x40>
    *ip = *(int*)(addr);
8010560f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105612:	8b 53 04             	mov    0x4(%ebx),%edx
...
80105620:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    return fetchint((myproc()->tf->esp) + 4 + 4 * n, ip);
80105625:	eb f2                	jmp    80105619 <argint+0x39>
...
8010563c:	8b 5d 10             	mov    0x10(%ebp),%ebx
    int i;
    struct proc* curproc = myproc();
8010563f:	e8 bc ee ff ff       	call   80104500 <myproc>
...
8010564d:	ff 75 08             	pushl  0x8(%ebp)
80105650:	e8 8b ff ff ff       	call   801055e0 <argint>
        return -1;
    if (size < 0 || (uint)i >= curproc->sz || (uint)i + size > curproc->sz)
80105655:	83 c4 10             	add    $0x10,%esp
80105658:	85 c0                	test   %eax,%eax
8010565a:	78 24                	js     80105680 <argptr+0x50>
8010565c:	85 db                	test   %ebx,%ebx
8010565e:	78 20                	js     80105680 <argptr+0x50>
80105660:	8b 16                	mov    (%esi),%edx
80105662:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105665:	39 c2                	cmp    %eax,%edx
80105667:	76 17                	jbe    80105680 <argptr+0x50>
80105669:	01 c3                	add    %eax,%ebx
8010566b:	39 da                	cmp    %ebx,%edx
8010566d:	72 11                	jb     80105680 <argptr+0x50>
        return -1;
    *pp = (char*)i;
8010566f:	8b 55 0c             	mov    0xc(%ebp),%edx
80105672:	89 02                	mov    %eax,(%edx)
    return 0;
80105674:	31 c0                	xor    %eax,%eax
}
80105676:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105679:	5b                   	pop    %ebx
8010567a:	5e                   	pop    %esi
8010567b:	5d                   	pop    %ebp
8010567c:	c3                   	ret    
...
80105685:	eb ef                	jmp    80105676 <argptr+0x46>
...
801056d8:	83 ec 04             	sub    $0x4,%esp
    int num;
    struct proc* curproc = myproc();
801056db:	e8 20 ee ff ff       	call   80104500 <myproc>
801056e0:	89 c3                	mov    %eax,%ebx

    num = curproc->tf->eax;
801056e2:	8b 40 18             	mov    0x18(%eax),%eax
801056e5:	8b 40 1c             	mov    0x1c(%eax),%eax
    if (num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801056e8:	8d 50 ff             	lea    -0x1(%eax),%edx
801056eb:	83 fa 18             	cmp    $0x18,%edx
801056ee:	77 20                	ja     80105710 <syscall+0x40>
801056f0:	8b 14 85 a0 85 10 80 	mov    -0x7fef7a60(,%eax,4),%edx
801056f7:	85 d2                	test   %edx,%edx
801056f9:	74 15                	je     80105710 <syscall+0x40>
        curproc->tf->eax = syscalls[num]();
801056fb:	ff d2                	call   *%edx
801056fd:	89 c2                	mov    %eax,%edx
801056ff:	8b 43 18             	mov    0x18(%ebx),%eax
80105702:	89 50 1c             	mov    %edx,0x1c(%eax)
    else {
...
80105710:	50                   	push   %eax
                curproc->pid, curproc->name, num);
80105711:	8d 43 6c             	lea    0x6c(%ebx),%eax
        cprintf("%d %s: unknown sys call %d\n",
80105714:	50                   	push   %eax
80105715:	ff 73 10             	pushl  0x10(%ebx)
80105718:	68 7d 85 10 80       	push   $0x8010857d
8010571d:	e8 9e b0 ff ff       	call   801007c0 <cprintf>
        curproc->tf->eax = -1;
80105722:	8b 43 18             	mov    0x18(%ebx),%eax
...
80105745:	8d 7d da             	lea    -0x26(%ebp),%edi
create(char* path, short type, short major, short minor) {
80105748:	53                   	push   %ebx
80105749:	83 ec 34             	sub    $0x34,%esp
8010574c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010574f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    if ((dp = nameiparent(path, name)) == 0)
80105752:	57                   	push   %edi
80105753:	50                   	push   %eax
create(char* path, short type, short major, short minor) {
80105754:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80105757:	89 4d cc             	mov    %ecx,-0x34(%ebp)
    if ((dp = nameiparent(path, name)) == 0)
8010575a:	e8 91 d4 ff ff       	call   80102bf0 <nameiparent>
8010575f:	83 c4 10             	add    $0x10,%esp
80105762:	85 c0                	test   %eax,%eax
80105764:	0f 84 46 01 00 00    	je     801058b0 <create+0x170>
        return 0;
    ilock(dp);
8010576a:	83 ec 0c             	sub    $0xc,%esp
8010576d:	89 c3                	mov    %eax,%ebx
8010576f:	50                   	push   %eax
80105770:	e8 8b cb ff ff       	call   80102300 <ilock>
...
8010577c:	e8 cf d0 ff ff       	call   80102850 <dirlookup>
80105781:	83 c4 10             	add    $0x10,%esp
80105784:	89 c6                	mov    %eax,%esi
80105786:	85 c0                	test   %eax,%eax
80105788:	74 56                	je     801057e0 <create+0xa0>
        iunlockput(dp);
8010578a:	83 ec 0c             	sub    $0xc,%esp
8010578d:	53                   	push   %ebx
8010578e:	e8 0d ce ff ff       	call   801025a0 <iunlockput>
        ilock(ip);
80105793:	89 34 24             	mov    %esi,(%esp)
80105796:	e8 65 cb ff ff       	call   80102300 <ilock>
        if (type == T_FILE && ip->type == T_FILE)
8010579b:	83 c4 10             	add    $0x10,%esp
8010579e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801057a3:	75 1b                	jne    801057c0 <create+0x80>
801057a5:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
801057aa:	75 14                	jne    801057c0 <create+0x80>
...
801057c3:	56                   	push   %esi
        return 0;
801057c4:	31 f6                	xor    %esi,%esi
        iunlockput(ip);
801057c6:	e8 d5 cd ff ff       	call   801025a0 <iunlockput>
        return 0;
801057cb:	83 c4 10             	add    $0x10,%esp
}
801057ce:	8d 65 f4             	lea    -0xc(%ebp),%esp
801057d1:	89 f0                	mov    %esi,%eax
801057d3:	5b                   	pop    %ebx
801057d4:	5e                   	pop    %esi
801057d5:	5f                   	pop    %edi
801057d6:	5d                   	pop    %ebp
...
801057e0:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
801057e4:	83 ec 08             	sub    $0x8,%esp
801057e7:	50                   	push   %eax
801057e8:	ff 33                	pushl  (%ebx)
801057ea:	e8 91 c9 ff ff       	call   80102180 <ialloc>
801057ef:	83 c4 10             	add    $0x10,%esp
801057f2:	89 c6                	mov    %eax,%esi
801057f4:	85 c0                	test   %eax,%eax
801057f6:	0f 84 cd 00 00 00    	je     801058c9 <create+0x189>
    ilock(ip);
801057fc:	83 ec 0c             	sub    $0xc,%esp
801057ff:	50                   	push   %eax
80105800:	e8 fb ca ff ff       	call   80102300 <ilock>
    ip->major = major;
80105805:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80105809:	66 89 46 52          	mov    %ax,0x52(%esi)
    ip->minor = minor;
8010580d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80105811:	66 89 46 54          	mov    %ax,0x54(%esi)
    ip->nlink = 1;
80105815:	b8 01 00 00 00       	mov    $0x1,%eax
8010581a:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(ip);
8010581e:	89 34 24             	mov    %esi,(%esp)
80105821:	e8 1a ca ff ff       	call   80102240 <iupdate>
    if (type == T_DIR) { // Create . and .. entries.
80105826:	83 c4 10             	add    $0x10,%esp
80105829:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010582e:	74 30                	je     80105860 <create+0x120>
    if (dirlink(dp, name, ip->inum) < 0)
80105830:	83 ec 04             	sub    $0x4,%esp
80105833:	ff 76 04             	pushl  0x4(%esi)
80105836:	57                   	push   %edi
80105837:	53                   	push   %ebx
80105838:	e8 d3 d2 ff ff       	call   80102b10 <dirlink>
8010583d:	83 c4 10             	add    $0x10,%esp
80105840:	85 c0                	test   %eax,%eax
80105842:	78 78                	js     801058bc <create+0x17c>
    iunlockput(dp);
80105844:	83 ec 0c             	sub    $0xc,%esp
80105847:	53                   	push   %ebx
80105848:	e8 53 cd ff ff       	call   801025a0 <iunlockput>
    return ip;
8010584d:	83 c4 10             	add    $0x10,%esp
}
80105850:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105853:	89 f0                	mov    %esi,%eax
80105855:	5b                   	pop    %ebx
80105856:	5e                   	pop    %esi
80105857:	5f                   	pop    %edi
80105858:	5d                   	pop    %ebp
...
80105860:	83 ec 0c             	sub    $0xc,%esp
        dp->nlink++;     // for ".."
80105863:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
        iupdate(dp);
80105868:	53                   	push   %ebx
80105869:	e8 d2 c9 ff ff       	call   80102240 <iupdate>
        if (dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010586e:	83 c4 0c             	add    $0xc,%esp
80105871:	ff 76 04             	pushl  0x4(%esi)
80105874:	68 24 86 10 80       	push   $0x80108624
80105879:	56                   	push   %esi
8010587a:	e8 91 d2 ff ff       	call   80102b10 <dirlink>
8010587f:	83 c4 10             	add    $0x10,%esp
80105882:	85 c0                	test   %eax,%eax
80105884:	78 18                	js     8010589e <create+0x15e>
80105886:	83 ec 04             	sub    $0x4,%esp
80105889:	ff 73 04             	pushl  0x4(%ebx)
8010588c:	68 23 86 10 80       	push   $0x80108623
80105891:	56                   	push   %esi
80105892:	e8 79 d2 ff ff       	call   80102b10 <dirlink>
80105897:	83 c4 10             	add    $0x10,%esp
8010589a:	85 c0                	test   %eax,%eax
8010589c:	79 92                	jns    80105830 <create+0xf0>
            panic("create dots");
8010589e:	83 ec 0c             	sub    $0xc,%esp
801058a1:	68 17 86 10 80       	push   $0x80108617
801058a6:	e8 e5 aa ff ff       	call   80100390 <panic>
801058ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801058af:	90                   	nop
}
801058b0:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
801058b3:	31 f6                	xor    %esi,%esi
}
801058b5:	5b                   	pop    %ebx
801058b6:	89 f0                	mov    %esi,%eax
801058b8:	5e                   	pop    %esi
801058b9:	5f                   	pop    %edi
801058ba:	5d                   	pop    %ebp
801058bb:	c3                   	ret    
...
801058bf:	68 26 86 10 80       	push   $0x80108626
801058c4:	e8 c7 aa ff ff       	call   80100390 <panic>
        panic("create: ialloc");
801058c9:	83 ec 0c             	sub    $0xc,%esp
801058cc:	68 08 86 10 80       	push   $0x80108608
...
801058f2:	e8 e9 fc ff ff       	call   801055e0 <argint>
801058f7:	83 c4 10             	add    $0x10,%esp
801058fa:	85 c0                	test   %eax,%eax
801058fc:	78 2a                	js     80105928 <argfd.constprop.0+0x48>
    if (fd < 0 || fd >= NOFILE || (f = myproc()->ofile[fd]) == 0)
801058fe:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80105902:	77 24                	ja     80105928 <argfd.constprop.0+0x48>
80105904:	e8 f7 eb ff ff       	call   80104500 <myproc>
80105909:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010590c:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80105910:	85 c0                	test   %eax,%eax
80105912:	74 14                	je     80105928 <argfd.constprop.0+0x48>
    if (pfd)
80105914:	85 db                	test   %ebx,%ebx
80105916:	74 02                	je     8010591a <argfd.constprop.0+0x3a>
        *pfd = fd;
80105918:	89 13                	mov    %edx,(%ebx)
        *pf = f;
8010591a:	89 06                	mov    %eax,(%esi)
    return 0;
...
8010592d:	eb ef                	jmp    8010591e <argfd.constprop.0+0x3e>
8010592f:	90                   	nop
...
8010593a:	53                   	push   %ebx
    if (argfd(0, 0, &f) < 0)
8010593b:	8d 55 f4             	lea    -0xc(%ebp),%edx
int sys_dup(void) {
8010593e:	83 ec 10             	sub    $0x10,%esp
    if (argfd(0, 0, &f) < 0)
80105941:	e8 9a ff ff ff       	call   801058e0 <argfd.constprop.0>
80105946:	85 c0                	test   %eax,%eax
80105948:	78 1e                	js     80105968 <sys_dup+0x38>
    if ((fd = fdalloc(f)) < 0)
8010594a:	8b 75 f4             	mov    -0xc(%ebp),%esi
    for (fd = 0; fd < NOFILE; fd++) {
8010594d:	31 db                	xor    %ebx,%ebx
    struct proc* curproc = myproc();
8010594f:	e8 ac eb ff ff       	call   80104500 <myproc>
    for (fd = 0; fd < NOFILE; fd++) {
80105954:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if (curproc->ofile[fd] == 0) {
80105958:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
8010595c:	85 d2                	test   %edx,%edx
8010595e:	74 20                	je     80105980 <sys_dup+0x50>
    for (fd = 0; fd < NOFILE; fd++) {
80105960:	83 c3 01             	add    $0x1,%ebx
80105963:	83 fb 10             	cmp    $0x10,%ebx
80105966:	75 f0                	jne    80105958 <sys_dup+0x28>
}
80105968:	8d 65 f8             	lea    -0x8(%ebp),%esp
        return -1;
8010596b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
801059a9:	83 ec 18             	sub    $0x18,%esp
    if (argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
801059ac:	8d 55 ec             	lea    -0x14(%ebp),%edx
801059af:	e8 2c ff ff ff       	call   801058e0 <argfd.constprop.0>
801059b4:	85 c0                	test   %eax,%eax
801059b6:	78 48                	js     80105a00 <sys_read+0x60>
801059b8:	83 ec 08             	sub    $0x8,%esp
801059bb:	8d 45 f0             	lea    -0x10(%ebp),%eax
801059be:	50                   	push   %eax
801059bf:	6a 02                	push   $0x2
801059c1:	e8 1a fc ff ff       	call   801055e0 <argint>
801059c6:	83 c4 10             	add    $0x10,%esp
801059c9:	85 c0                	test   %eax,%eax
801059cb:	78 33                	js     80105a00 <sys_read+0x60>
801059cd:	83 ec 04             	sub    $0x4,%esp
801059d0:	8d 45 f4             	lea    -0xc(%ebp),%eax
801059d3:	ff 75 f0             	pushl  -0x10(%ebp)
801059d6:	50                   	push   %eax
801059d7:	6a 01                	push   $0x1
801059d9:	e8 52 fc ff ff       	call   80105630 <argptr>
801059de:	83 c4 10             	add    $0x10,%esp
801059e1:	85 c0                	test   %eax,%eax
801059e3:	78 1b                	js     80105a00 <sys_read+0x60>
    return fileread(f, p, n);
801059e5:	83 ec 04             	sub    $0x4,%esp
801059e8:	ff 75 f0             	pushl  -0x10(%ebp)
801059eb:	ff 75 f4             	pushl  -0xc(%ebp)
801059ee:	ff 75 ec             	pushl  -0x14(%ebp)
801059f1:	e8 ea c0 ff ff       	call   80101ae0 <fileread>
...
80105a19:	83 ec 18             	sub    $0x18,%esp
    if (argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80105a1c:	8d 55 ec             	lea    -0x14(%ebp),%edx
80105a1f:	e8 bc fe ff ff       	call   801058e0 <argfd.constprop.0>
80105a24:	85 c0                	test   %eax,%eax
80105a26:	78 48                	js     80105a70 <sys_write+0x60>
80105a28:	83 ec 08             	sub    $0x8,%esp
80105a2b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105a2e:	50                   	push   %eax
80105a2f:	6a 02                	push   $0x2
80105a31:	e8 aa fb ff ff       	call   801055e0 <argint>
80105a36:	83 c4 10             	add    $0x10,%esp
80105a39:	85 c0                	test   %eax,%eax
80105a3b:	78 33                	js     80105a70 <sys_write+0x60>
...
80105a49:	e8 e2 fb ff ff       	call   80105630 <argptr>
80105a4e:	83 c4 10             	add    $0x10,%esp
80105a51:	85 c0                	test   %eax,%eax
80105a53:	78 1b                	js     80105a70 <sys_write+0x60>
    return filewrite(f, p, n);
80105a55:	83 ec 04             	sub    $0x4,%esp
80105a58:	ff 75 f0             	pushl  -0x10(%ebp)
80105a5b:	ff 75 f4             	pushl  -0xc(%ebp)
80105a5e:	ff 75 ec             	pushl  -0x14(%ebp)
80105a61:	e8 1a c1 ff ff       	call   80101b80 <filewrite>
...
80105a87:	83 ec 18             	sub    $0x18,%esp
    if (argfd(0, &fd, &f) < 0)
80105a8a:	8d 55 f4             	lea    -0xc(%ebp),%edx
80105a8d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105a90:	e8 4b fe ff ff       	call   801058e0 <argfd.constprop.0>
80105a95:	85 c0                	test   %eax,%eax
80105a97:	78 27                	js     80105ac0 <sys_close+0x40>
    myproc()->ofile[fd] = 0;
80105a99:	e8 62 ea ff ff       	call   80104500 <myproc>
80105a9e:	8b 55 f0             	mov    -0x10(%ebp),%edx
    fileclose(f);
80105aa1:	83 ec 0c             	sub    $0xc,%esp
    myproc()->ofile[fd] = 0;
80105aa4:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80105aab:	00 
    fileclose(f);
80105aac:	ff 75 f4             	pushl  -0xc(%ebp)
80105aaf:	e8 fc be ff ff       	call   801019b0 <fileclose>
    return 0;
...
80105ad9:	83 ec 18             	sub    $0x18,%esp
    if (argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80105adc:	8d 55 f0             	lea    -0x10(%ebp),%edx
80105adf:	e8 fc fd ff ff       	call   801058e0 <argfd.constprop.0>
80105ae4:	85 c0                	test   %eax,%eax
80105ae6:	78 30                	js     80105b18 <sys_fstat+0x48>
80105ae8:	83 ec 04             	sub    $0x4,%esp
80105aeb:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105aee:	6a 14                	push   $0x14
80105af0:	50                   	push   %eax
80105af1:	6a 01                	push   $0x1
80105af3:	e8 38 fb ff ff       	call   80105630 <argptr>
80105af8:	83 c4 10             	add    $0x10,%esp
80105afb:	85 c0                	test   %eax,%eax
80105afd:	78 19                	js     80105b18 <sys_fstat+0x48>
    return filestat(f, st);
80105aff:	83 ec 08             	sub    $0x8,%esp
80105b02:	ff 75 f4             	pushl  -0xc(%ebp)
80105b05:	ff 75 f0             	pushl  -0x10(%ebp)
80105b08:	e8 83 bf ff ff       	call   80101a90 <filestat>
...
80105b29:	8d 45 d4             	lea    -0x2c(%ebp),%eax
int sys_link(void) {
80105b2c:	53                   	push   %ebx
80105b2d:	83 ec 34             	sub    $0x34,%esp
    if (argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105b30:	50                   	push   %eax
80105b31:	6a 00                	push   $0x0
80105b33:	e8 58 fb ff ff       	call   80105690 <argstr>
80105b38:	83 c4 10             	add    $0x10,%esp
80105b3b:	85 c0                	test   %eax,%eax
80105b3d:	0f 88 ff 00 00 00    	js     80105c42 <sys_link+0x122>
80105b43:	83 ec 08             	sub    $0x8,%esp
80105b46:	8d 45 d0             	lea    -0x30(%ebp),%eax
80105b49:	50                   	push   %eax
80105b4a:	6a 01                	push   $0x1
80105b4c:	e8 3f fb ff ff       	call   80105690 <argstr>
80105b51:	83 c4 10             	add    $0x10,%esp
80105b54:	85 c0                	test   %eax,%eax
80105b56:	0f 88 e6 00 00 00    	js     80105c42 <sys_link+0x122>
    begin_op();
80105b5c:	e8 6f dd ff ff       	call   801038d0 <begin_op>
    if ((ip = namei(old)) == 0) {
80105b61:	83 ec 0c             	sub    $0xc,%esp
80105b64:	ff 75 d4             	pushl  -0x2c(%ebp)
80105b67:	e8 64 d0 ff ff       	call   80102bd0 <namei>
80105b6c:	83 c4 10             	add    $0x10,%esp
80105b6f:	89 c3                	mov    %eax,%ebx
80105b71:	85 c0                	test   %eax,%eax
80105b73:	0f 84 e8 00 00 00    	je     80105c61 <sys_link+0x141>
    ilock(ip);
80105b79:	83 ec 0c             	sub    $0xc,%esp
80105b7c:	50                   	push   %eax
80105b7d:	e8 7e c7 ff ff       	call   80102300 <ilock>
    if (ip->type == T_DIR) {
80105b82:	83 c4 10             	add    $0x10,%esp
80105b85:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105b8a:	0f 84 b9 00 00 00    	je     80105c49 <sys_link+0x129>
    iupdate(ip);
80105b90:	83 ec 0c             	sub    $0xc,%esp
    ip->nlink++;
80105b93:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    if ((dp = nameiparent(new, name)) == 0)
80105b98:	8d 7d da             	lea    -0x26(%ebp),%edi
    iupdate(ip);
80105b9b:	53                   	push   %ebx
80105b9c:	e8 9f c6 ff ff       	call   80102240 <iupdate>
    iunlock(ip);
80105ba1:	89 1c 24             	mov    %ebx,(%esp)
80105ba4:	e8 37 c8 ff ff       	call   801023e0 <iunlock>
    if ((dp = nameiparent(new, name)) == 0)
80105ba9:	58                   	pop    %eax
80105baa:	5a                   	pop    %edx
80105bab:	57                   	push   %edi
80105bac:	ff 75 d0             	pushl  -0x30(%ebp)
80105baf:	e8 3c d0 ff ff       	call   80102bf0 <nameiparent>
80105bb4:	83 c4 10             	add    $0x10,%esp
80105bb7:	89 c6                	mov    %eax,%esi
80105bb9:	85 c0                	test   %eax,%eax
80105bbb:	74 5f                	je     80105c1c <sys_link+0xfc>
    ilock(dp);
80105bbd:	83 ec 0c             	sub    $0xc,%esp
80105bc0:	50                   	push   %eax
80105bc1:	e8 3a c7 ff ff       	call   80102300 <ilock>
    if (dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0) {
80105bc6:	8b 03                	mov    (%ebx),%eax
80105bc8:	83 c4 10             	add    $0x10,%esp
80105bcb:	39 06                	cmp    %eax,(%esi)
80105bcd:	75 41                	jne    80105c10 <sys_link+0xf0>
80105bcf:	83 ec 04             	sub    $0x4,%esp
80105bd2:	ff 73 04             	pushl  0x4(%ebx)
80105bd5:	57                   	push   %edi
80105bd6:	56                   	push   %esi
80105bd7:	e8 34 cf ff ff       	call   80102b10 <dirlink>
80105bdc:	83 c4 10             	add    $0x10,%esp
80105bdf:	85 c0                	test   %eax,%eax
80105be1:	78 2d                	js     80105c10 <sys_link+0xf0>
    iunlockput(dp);
80105be3:	83 ec 0c             	sub    $0xc,%esp
80105be6:	56                   	push   %esi
80105be7:	e8 b4 c9 ff ff       	call   801025a0 <iunlockput>
    iput(ip);
80105bec:	89 1c 24             	mov    %ebx,(%esp)
80105bef:	e8 3c c8 ff ff       	call   80102430 <iput>
    end_op();
80105bf4:	e8 47 dd ff ff       	call   80103940 <end_op>
    return 0;
...
80105c14:	e8 87 c9 ff ff       	call   801025a0 <iunlockput>
        goto bad;
80105c19:	83 c4 10             	add    $0x10,%esp
    ilock(ip);
80105c1c:	83 ec 0c             	sub    $0xc,%esp
80105c1f:	53                   	push   %ebx
80105c20:	e8 db c6 ff ff       	call   80102300 <ilock>
    ip->nlink--;
80105c25:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
    iupdate(ip);
80105c2a:	89 1c 24             	mov    %ebx,(%esp)
80105c2d:	e8 0e c6 ff ff       	call   80102240 <iupdate>
    iunlockput(ip);
80105c32:	89 1c 24             	mov    %ebx,(%esp)
80105c35:	e8 66 c9 ff ff       	call   801025a0 <iunlockput>
    end_op();
80105c3a:	e8 01 dd ff ff       	call   80103940 <end_op>
    return -1;
80105c3f:	83 c4 10             	add    $0x10,%esp
80105c42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c47:	eb b5                	jmp    80105bfe <sys_link+0xde>
        iunlockput(ip);
80105c49:	83 ec 0c             	sub    $0xc,%esp
80105c4c:	53                   	push   %ebx
80105c4d:	e8 4e c9 ff ff       	call   801025a0 <iunlockput>
        end_op();
80105c52:	e8 e9 dc ff ff       	call   80103940 <end_op>
        return -1;
80105c57:	83 c4 10             	add    $0x10,%esp
80105c5a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c5f:	eb 9d                	jmp    80105bfe <sys_link+0xde>
        end_op();
80105c61:	e8 da dc ff ff       	call   80103940 <end_op>
        return -1;
80105c66:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c6b:	eb 91                	jmp    80105bfe <sys_link+0xde>
...
80105c78:	56                   	push   %esi
    if (argstr(0, &path) < 0)
80105c79:	8d 45 c0             	lea    -0x40(%ebp),%eax
int sys_unlink(void) {
80105c7c:	53                   	push   %ebx
80105c7d:	83 ec 54             	sub    $0x54,%esp
    if (argstr(0, &path) < 0)
80105c80:	50                   	push   %eax
80105c81:	6a 00                	push   $0x0
80105c83:	e8 08 fa ff ff       	call   80105690 <argstr>
80105c88:	83 c4 10             	add    $0x10,%esp
80105c8b:	85 c0                	test   %eax,%eax
80105c8d:	0f 88 7d 01 00 00    	js     80105e10 <sys_unlink+0x1a0>
    begin_op();
80105c93:	e8 38 dc ff ff       	call   801038d0 <begin_op>
    if ((dp = nameiparent(path, name)) == 0) {
80105c98:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105c9b:	83 ec 08             	sub    $0x8,%esp
80105c9e:	53                   	push   %ebx
80105c9f:	ff 75 c0             	pushl  -0x40(%ebp)
80105ca2:	e8 49 cf ff ff       	call   80102bf0 <nameiparent>
80105ca7:	83 c4 10             	add    $0x10,%esp
80105caa:	89 c6                	mov    %eax,%esi
80105cac:	85 c0                	test   %eax,%eax
80105cae:	0f 84 66 01 00 00    	je     80105e1a <sys_unlink+0x1aa>
    ilock(dp);
80105cb4:	83 ec 0c             	sub    $0xc,%esp
80105cb7:	50                   	push   %eax
80105cb8:	e8 43 c6 ff ff       	call   80102300 <ilock>
    if (namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105cbd:	58                   	pop    %eax
80105cbe:	5a                   	pop    %edx
80105cbf:	68 24 86 10 80       	push   $0x80108624
80105cc4:	53                   	push   %ebx
80105cc5:	e8 66 cb ff ff       	call   80102830 <namecmp>
80105cca:	83 c4 10             	add    $0x10,%esp
80105ccd:	85 c0                	test   %eax,%eax
80105ccf:	0f 84 03 01 00 00    	je     80105dd8 <sys_unlink+0x168>
80105cd5:	83 ec 08             	sub    $0x8,%esp
80105cd8:	68 23 86 10 80       	push   $0x80108623
80105cdd:	53                   	push   %ebx
80105cde:	e8 4d cb ff ff       	call   80102830 <namecmp>
80105ce3:	83 c4 10             	add    $0x10,%esp
80105ce6:	85 c0                	test   %eax,%eax
80105ce8:	0f 84 ea 00 00 00    	je     80105dd8 <sys_unlink+0x168>
...
80105d32:	e8 c9 f5 ff ff       	call   80105300 <memset>
    if (writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105d37:	6a 10                	push   $0x10
80105d39:	ff 75 c4             	pushl  -0x3c(%ebp)
80105d3c:	57                   	push   %edi
80105d3d:	56                   	push   %esi
80105d3e:	e8 bd c9 ff ff       	call   80102700 <writei>
80105d43:	83 c4 20             	add    $0x20,%esp
80105d46:	83 f8 10             	cmp    $0x10,%eax
80105d49:	0f 85 e7 00 00 00    	jne    80105e36 <sys_unlink+0x1c6>
    if (ip->type == T_DIR) {
80105d4f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105d54:	0f 84 96 00 00 00    	je     80105df0 <sys_unlink+0x180>
    iunlockput(dp);
80105d5a:	83 ec 0c             	sub    $0xc,%esp
80105d5d:	56                   	push   %esi
80105d5e:	e8 3d c8 ff ff       	call   801025a0 <iunlockput>
    ip->nlink--;
80105d63:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
    iupdate(ip);
80105d68:	89 1c 24             	mov    %ebx,(%esp)
80105d6b:	e8 d0 c4 ff ff       	call   80102240 <iupdate>
    iunlockput(ip);
80105d70:	89 1c 24             	mov    %ebx,(%esp)
80105d73:	e8 28 c8 ff ff       	call   801025a0 <iunlockput>
    end_op();
80105d78:	e8 c3 db ff ff       	call   80103940 <end_op>
    return 0;
80105d7d:	83 c4 10             	add    $0x10,%esp
80105d80:	31 c0                	xor    %eax,%eax
}
80105d82:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105d85:	5b                   	pop    %ebx
80105d86:	5e                   	pop    %esi
80105d87:	5f                   	pop    %edi
80105d88:	5d                   	pop    %ebp
...
80105d96:	ba 20 00 00 00       	mov    $0x20,%edx
80105d9b:	eb 0b                	jmp    80105da8 <sys_unlink+0x138>
80105d9d:	8d 76 00             	lea    0x0(%esi),%esi
80105da0:	83 c2 10             	add    $0x10,%edx
80105da3:	39 53 58             	cmp    %edx,0x58(%ebx)
80105da6:	76 82                	jbe    80105d2a <sys_unlink+0xba>
        if (readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105da8:	6a 10                	push   $0x10
80105daa:	52                   	push   %edx
80105dab:	57                   	push   %edi
80105dac:	53                   	push   %ebx
80105dad:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80105db0:	e8 4b c8 ff ff       	call   80102600 <readi>
80105db5:	83 c4 10             	add    $0x10,%esp
80105db8:	8b 55 b4             	mov    -0x4c(%ebp),%edx
80105dbb:	83 f8 10             	cmp    $0x10,%eax
80105dbe:	75 69                	jne    80105e29 <sys_unlink+0x1b9>
        if (de.inum != 0)
80105dc0:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105dc5:	74 d9                	je     80105da0 <sys_unlink+0x130>
        iunlockput(ip);
80105dc7:	83 ec 0c             	sub    $0xc,%esp
80105dca:	53                   	push   %ebx
80105dcb:	e8 d0 c7 ff ff       	call   801025a0 <iunlockput>
        goto bad;
...
80105ddc:	e8 bf c7 ff ff       	call   801025a0 <iunlockput>
    end_op();
80105de1:	e8 5a db ff ff       	call   80103940 <end_op>
    return -1;
80105de6:	83 c4 10             	add    $0x10,%esp
80105de9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dee:	eb 92                	jmp    80105d82 <sys_unlink+0x112>
        iupdate(dp);
80105df0:	83 ec 0c             	sub    $0xc,%esp
        dp->nlink--;
80105df3:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
        iupdate(dp);
80105df8:	56                   	push   %esi
80105df9:	e8 42 c4 ff ff       	call   80102240 <iupdate>
80105dfe:	83 c4 10             	add    $0x10,%esp
80105e01:	e9 54 ff ff ff       	jmp    80105d5a <sys_unlink+0xea>
...
80105e15:	e9 68 ff ff ff       	jmp    80105d82 <sys_unlink+0x112>
        end_op();
80105e1a:	e8 21 db ff ff       	call   80103940 <end_op>
        return -1;
80105e1f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e24:	e9 59 ff ff ff       	jmp    80105d82 <sys_unlink+0x112>
            panic("isdirempty: readi");
80105e29:	83 ec 0c             	sub    $0xc,%esp
80105e2c:	68 48 86 10 80       	push   $0x80108648
80105e31:	e8 5a a5 ff ff       	call   80100390 <panic>
        panic("unlink: writei");
80105e36:	83 ec 0c             	sub    $0xc,%esp
80105e39:	68 5a 86 10 80       	push   $0x8010865a
80105e3e:	e8 4d a5 ff ff       	call   80100390 <panic>
        panic("unlink: nlink < 1");
80105e43:	83 ec 0c             	sub    $0xc,%esp
80105e46:	68 36 86 10 80       	push   $0x80108636
80105e4b:	e8 40 a5 ff ff       	call   80100390 <panic>
...
80105e59:	8d 45 e0             	lea    -0x20(%ebp),%eax
int sys_open(void) {
80105e5c:	53                   	push   %ebx
80105e5d:	83 ec 24             	sub    $0x24,%esp
    if (argstr(0, &path) < 0 || argint(1, &omode) < 0)
80105e60:	50                   	push   %eax
80105e61:	6a 00                	push   $0x0
80105e63:	e8 28 f8 ff ff       	call   80105690 <argstr>
80105e68:	83 c4 10             	add    $0x10,%esp
80105e6b:	85 c0                	test   %eax,%eax
80105e6d:	0f 88 8a 00 00 00    	js     80105efd <sys_open+0xad>
80105e73:	83 ec 08             	sub    $0x8,%esp
80105e76:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e79:	50                   	push   %eax
80105e7a:	6a 01                	push   $0x1
80105e7c:	e8 5f f7 ff ff       	call   801055e0 <argint>
80105e81:	83 c4 10             	add    $0x10,%esp
80105e84:	85 c0                	test   %eax,%eax
80105e86:	78 75                	js     80105efd <sys_open+0xad>
        return -1;

    begin_op();
80105e88:	e8 43 da ff ff       	call   801038d0 <begin_op>

    if (omode & O_CREATE) {
80105e8d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105e91:	75 75                	jne    80105f08 <sys_open+0xb8>
            end_op();
            return -1;
        }
    }
...
80105e99:	e8 32 cd ff ff       	call   80102bd0 <namei>
80105e9e:	83 c4 10             	add    $0x10,%esp
80105ea1:	89 c6                	mov    %eax,%esi
80105ea3:	85 c0                	test   %eax,%eax
80105ea5:	74 7e                	je     80105f25 <sys_open+0xd5>
            end_op();
            return -1;
        }
        ilock(ip);
...
80105eab:	e8 50 c4 ff ff       	call   80102300 <ilock>
...
80105ee4:	e8 c7 ba ff ff       	call   801019b0 <fileclose>
80105ee9:	83 c4 10             	add    $0x10,%esp
        iunlockput(ip);
80105eec:	83 ec 0c             	sub    $0xc,%esp
80105eef:	56                   	push   %esi
80105ef0:	e8 ab c6 ff ff       	call   801025a0 <iunlockput>
        end_op();
80105ef5:	e8 46 da ff ff       	call   80103940 <end_op>
        return -1;
...
80105f17:	e8 24 f8 ff ff       	call   80105740 <create>
        if (ip == 0) {
...
80105f23:	75 99                	jne    80105ebe <sys_open+0x6e>
            end_op();
80105f25:	e8 16 da ff ff       	call   80103940 <end_op>
            return -1;
...
80105f40:	e8 9b c4 ff ff       	call   801023e0 <iunlock>
    end_op();
80105f45:	e8 f6 d9 ff ff       	call   80103940 <end_op>
...
80105f97:	83 ec 18             	sub    $0x18,%esp
    char* path;
    struct inode* ip;

    begin_op();
80105f9a:	e8 31 d9 ff ff       	call   801038d0 <begin_op>
    if (argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0) {
80105f9f:	83 ec 08             	sub    $0x8,%esp
80105fa2:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105fa5:	50                   	push   %eax
80105fa6:	6a 00                	push   $0x0
80105fa8:	e8 e3 f6 ff ff       	call   80105690 <argstr>
80105fad:	83 c4 10             	add    $0x10,%esp
80105fb0:	85 c0                	test   %eax,%eax
80105fb2:	78 34                	js     80105fe8 <sys_mkdir+0x58>
80105fb4:	83 ec 0c             	sub    $0xc,%esp
80105fb7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fba:	31 c9                	xor    %ecx,%ecx
80105fbc:	ba 01 00 00 00       	mov    $0x1,%edx
80105fc1:	6a 00                	push   $0x0
80105fc3:	e8 78 f7 ff ff       	call   80105740 <create>
80105fc8:	83 c4 10             	add    $0x10,%esp
80105fcb:	85 c0                	test   %eax,%eax
80105fcd:	74 19                	je     80105fe8 <sys_mkdir+0x58>
        end_op();
        return -1;
    }
    iunlockput(ip);
...
80105fd3:	e8 c8 c5 ff ff       	call   801025a0 <iunlockput>
    end_op();
80105fd8:	e8 63 d9 ff ff       	call   80103940 <end_op>
    return 0;
...
80105fe4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        end_op();
80105fe8:	e8 53 d9 ff ff       	call   80103940 <end_op>
        return -1;
...
80106072:	e8 29 c5 ff ff       	call   801025a0 <iunlockput>
    end_op();
80106077:	e8 c4 d8 ff ff       	call   80103940 <end_op>
    return 0;
...
80106087:	90                   	nop
        end_op();
80106088:	e8 b3 d8 ff ff       	call   80103940 <end_op>
        return -1;
...
801060a9:	83 ec 10             	sub    $0x10,%esp
    ...
    struct inode* ip;
    struct proc* curproc = myproc();
801060ac:	e8 4f e4 ff ff       	call   80104500 <myproc>
801060b1:	89 c6                	mov    %eax,%esi

    begin_op();
801060b3:	e8 18 d8 ff ff       	call   801038d0 <begin_op>
    if (argstr(0, &path) < 0 || (ip = namei(path)) == 0) {
801060b8:	83 ec 08             	sub    $0x8,%esp
801060bb:	8d 45 f4             	lea    -0xc(%ebp),%eax
801060be:	50                   	push   %eax
801060bf:	6a 00                	push   $0x0
801060c1:	e8 ca f5 ff ff       	call   80105690 <argstr>
801060c6:	83 c4 10             	add    $0x10,%esp
801060c9:	85 c0                	test   %eax,%eax
801060cb:	78 73                	js     80106140 <sys_chdir+0xa0>
801060cd:	83 ec 0c             	sub    $0xc,%esp
801060d0:	ff 75 f4             	pushl  -0xc(%ebp)
801060d3:	e8 f8 ca ff ff       	call   80102bd0 <namei>
801060d8:	83 c4 10             	add    $0x10,%esp
801060db:	89 c3                	mov    %eax,%ebx
801060dd:	85 c0                	test   %eax,%eax
801060df:	74 5f                	je     80106140 <sys_chdir+0xa0>
        end_op();
        return -1;
    }
    ilock(ip);
...
801060e5:	e8 16 c2 ff ff       	call   80102300 <ilock>
    if (ip->type != T_DIR) {
801060ea:	83 c4 10             	add    $0x10,%esp
801060ed:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801060f2:	75 2c                	jne    80106120 <sys_chdir+0x80>
        iunlockput(ip);
        end_op();
        return -1;
    }
...
801060f8:	e8 e3 c2 ff ff       	call   801023e0 <iunlock>
    iput(curproc->cwd);
801060fd:	58                   	pop    %eax
801060fe:	ff 76 68             	pushl  0x68(%esi)
80106101:	e8 2a c3 ff ff       	call   80102430 <iput>
    end_op();
80106106:	e8 35 d8 ff ff       	call   80103940 <end_op>
    curproc->cwd = ip;
8010610b:	89 5e 68             	mov    %ebx,0x68(%esi)
    return 0;
...
80106124:	e8 77 c4 ff ff       	call   801025a0 <iunlockput>
        end_op();
80106129:	e8 12 d8 ff ff       	call   80103940 <end_op>
        return -1;
8010612e:	83 c4 10             	add    $0x10,%esp
80106131:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106136:	eb db                	jmp    80106113 <sys_chdir+0x73>
80106138:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010613f:	90                   	nop
        end_op();
80106140:	e8 fb d7 ff ff       	call   80103940 <end_op>
        return -1;
80106145:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010614a:	eb c7                	jmp    80106113 <sys_chdir+0x73>
...
80106159:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
int sys_exec(void) {
8010615f:	53                   	push   %ebx
80106160:	81 ec a4 00 00 00    	sub    $0xa4,%esp
    if (argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0) {
80106166:	50                   	push   %eax
80106167:	6a 00                	push   $0x0
80106169:	e8 22 f5 ff ff       	call   80105690 <argstr>
8010616e:	83 c4 10             	add    $0x10,%esp
80106171:	85 c0                	test   %eax,%eax
80106173:	0f 88 8b 00 00 00    	js     80106204 <sys_exec+0xb4>
80106179:	83 ec 08             	sub    $0x8,%esp
8010617c:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80106182:	50                   	push   %eax
80106183:	6a 01                	push   $0x1
80106185:	e8 56 f4 ff ff       	call   801055e0 <argint>
8010618a:	83 c4 10             	add    $0x10,%esp
8010618d:	85 c0                	test   %eax,%eax
8010618f:	78 73                	js     80106204 <sys_exec+0xb4>
        return -1;
    }
    memset(argv, 0, sizeof(argv));
80106191:	83 ec 04             	sub    $0x4,%esp
80106194:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
    for (i = 0;; i++) {
8010619a:	31 db                	xor    %ebx,%ebx
    memset(argv, 0, sizeof(argv));
8010619c:	68 80 00 00 00       	push   $0x80
801061a1:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
801061a7:	6a 00                	push   $0x0
801061a9:	50                   	push   %eax
801061aa:	e8 51 f1 ff ff       	call   80105300 <memset>
801061af:	83 c4 10             	add    $0x10,%esp
801061b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if (i >= NELEM(argv))
            return -1;
        if (fetchint(uargv + 4 * i, (int*)&uarg) < 0)
801061b8:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801061be:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
801061c5:	83 ec 08             	sub    $0x8,%esp
801061c8:	57                   	push   %edi
801061c9:	01 f0                	add    %esi,%eax
801061cb:	50                   	push   %eax
801061cc:	e8 6f f3 ff ff       	call   80105540 <fetchint>
801061d1:	83 c4 10             	add    $0x10,%esp
801061d4:	85 c0                	test   %eax,%eax
801061d6:	78 2c                	js     80106204 <sys_exec+0xb4>
            return -1;
        if (uarg == 0) {
801061d8:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801061de:	85 c0                	test   %eax,%eax
801061e0:	74 36                	je     80106218 <sys_exec+0xc8>
            argv[i] = 0;
            break;
        }
        if (fetchstr(uarg, &argv[i]) < 0)
801061e2:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
801061e8:	83 ec 08             	sub    $0x8,%esp
801061eb:	8d 14 31             	lea    (%ecx,%esi,1),%edx
801061ee:	52                   	push   %edx
801061ef:	50                   	push   %eax
801061f0:	e8 8b f3 ff ff       	call   80105580 <fetchstr>
801061f5:	83 c4 10             	add    $0x10,%esp
801061f8:	85 c0                	test   %eax,%eax
801061fa:	78 08                	js     80106204 <sys_exec+0xb4>
    for (i = 0;; i++) {
801061fc:	83 c3 01             	add    $0x1,%ebx
        if (i >= NELEM(argv))
801061ff:	83 fb 20             	cmp    $0x20,%ebx
80106202:	75 b4                	jne    801061b8 <sys_exec+0x68>
            return -1;
    }
    return exec(path, argv);
}
80106204:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return -1;
...
8010621b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
            argv[i] = 0;
80106221:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80106228:	00 00 00 00 
    return exec(path, argv);
8010622c:	50                   	push   %eax
8010622d:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80106233:	e8 38 b3 ff ff       	call   80101570 <exec>
...
80106259:	8d 45 dc             	lea    -0x24(%ebp),%eax
int sys_pipe(void) {
8010625c:	53                   	push   %ebx
8010625d:	83 ec 20             	sub    $0x20,%esp
    if (argptr(0, (void*)&fd, 2 * sizeof(fd[0])) < 0)
80106260:	6a 08                	push   $0x8
80106262:	50                   	push   %eax
80106263:	6a 00                	push   $0x0
80106265:	e8 c6 f3 ff ff       	call   80105630 <argptr>
8010626a:	83 c4 10             	add    $0x10,%esp
8010626d:	85 c0                	test   %eax,%eax
8010626f:	78 4e                	js     801062bf <sys_pipe+0x6f>
        return -1;
    if (pipealloc(&rf, &wf) < 0)
80106271:	83 ec 08             	sub    $0x8,%esp
80106274:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106277:	50                   	push   %eax
80106278:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010627b:	50                   	push   %eax
8010627c:	e8 0f dd ff ff       	call   80103f90 <pipealloc>
80106281:	83 c4 10             	add    $0x10,%esp
80106284:	85 c0                	test   %eax,%eax
80106286:	78 37                	js     801062bf <sys_pipe+0x6f>
        return -1;
    fd0 = -1;
    if ((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0) {
80106288:	8b 7d e0             	mov    -0x20(%ebp),%edi
    for (fd = 0; fd < NOFILE; fd++) {
8010628b:	31 db                	xor    %ebx,%ebx
    struct proc* curproc = myproc();
8010628d:	e8 6e e2 ff ff       	call   80104500 <myproc>
    for (fd = 0; fd < NOFILE; fd++) {
80106292:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if (curproc->ofile[fd] == 0) {
80106298:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
8010629c:	85 f6                	test   %esi,%esi
8010629e:	74 30                	je     801062d0 <sys_pipe+0x80>
    for (fd = 0; fd < NOFILE; fd++) {
801062a0:	83 c3 01             	add    $0x1,%ebx
801062a3:	83 fb 10             	cmp    $0x10,%ebx
801062a6:	75 f0                	jne    80106298 <sys_pipe+0x48>
        if (fd0 >= 0)
            myproc()->ofile[fd0] = 0;
        fileclose(rf);
801062a8:	83 ec 0c             	sub    $0xc,%esp
801062ab:	ff 75 e0             	pushl  -0x20(%ebp)
801062ae:	e8 fd b6 ff ff       	call   801019b0 <fileclose>
        fileclose(wf);
801062b3:	58                   	pop    %eax
801062b4:	ff 75 e4             	pushl  -0x1c(%ebp)
801062b7:	e8 f4 b6 ff ff       	call   801019b0 <fileclose>
        return -1;
801062bc:	83 c4 10             	add    $0x10,%esp
801062bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c4:	eb 5b                	jmp    80106321 <sys_pipe+0xd1>
...
801062d7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    struct proc* curproc = myproc();
801062da:	e8 21 e2 ff ff       	call   80104500 <myproc>
    for (fd = 0; fd < NOFILE; fd++) {
801062df:	31 d2                	xor    %edx,%edx
801062e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        if (curproc->ofile[fd] == 0) {
801062e8:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
801062ec:	85 c9                	test   %ecx,%ecx
801062ee:	74 20                	je     80106310 <sys_pipe+0xc0>
    for (fd = 0; fd < NOFILE; fd++) {
801062f0:	83 c2 01             	add    $0x1,%edx
801062f3:	83 fa 10             	cmp    $0x10,%edx
801062f6:	75 f0                	jne    801062e8 <sys_pipe+0x98>
            myproc()->ofile[fd0] = 0;
801062f8:	e8 03 e2 ff ff       	call   80104500 <myproc>
801062fd:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80106304:	00 
80106305:	eb a1                	jmp    801062a8 <sys_pipe+0x58>
80106307:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010630e:	66 90                	xchg   %ax,%ax
            curproc->ofile[fd] = f;
80106310:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
    }
    fd[0] = fd0;
...
80106342:	e8 49 f3 ff ff       	call   80105690 <argstr>
    argstr(1, &dest_path);
80106347:	58                   	pop    %eax
...
8010634f:	e8 3c f3 ff ff       	call   80105690 <argstr>
    struct inode* src = namei(src_path);
80106354:	59                   	pop    %ecx
80106355:	ff 75 f0             	pushl  -0x10(%ebp)
80106358:	e8 73 c8 ff ff       	call   80102bd0 <namei>
    struct inode* dest = namei(dest_path);
8010635d:	5b                   	pop    %ebx
8010635e:	ff 75 f4             	pushl  -0xc(%ebp)
    struct inode* src = namei(src_path);
80106361:	89 c6                	mov    %eax,%esi
    struct inode* dest = namei(dest_path);
80106363:	e8 68 c8 ff ff       	call   80102bd0 <namei>
    if(src == 0){
80106368:	83 c4 10             	add    $0x10,%esp
8010636b:	85 f6                	test   %esi,%esi
8010636d:	74 63                	je     801063d2 <sys_fcopy+0xa2>
...
80106373:	74 2b                	je     801063a0 <sys_fcopy+0x70>
        dest = create(dest_path, T_FILE, 0, 1);
    }
    else if(src == dest) {
80106375:	39 c6                	cmp    %eax,%esi
80106377:	74 42                	je     801063bb <sys_fcopy+0x8b>
...
8010637c:	68 ac 86 10 80       	push   $0x801086ac
80106381:	e8 3a a4 ff ff       	call   801007c0 <cprintf>
...
8010638e:	e8 0d b9 ff ff       	call   80101ca0 <fcopy>
...
801063a6:	31 c9                	xor    %ecx,%ecx
801063a8:	ba 02 00 00 00       	mov    $0x2,%edx
801063ad:	6a 01                	push   $0x1
801063af:	e8 8c f3 ff ff       	call   80105740 <create>
801063b4:	83 c4 10             	add    $0x10,%esp
801063b7:	89 c3                	mov    %eax,%ebx
801063b9:	eb ce                	jmp    80106389 <sys_fcopy+0x59>
        cprintf("a file can not be copy at itself!\n");
801063bb:	83 ec 0c             	sub    $0xc,%esp
801063be:	68 88 86 10 80       	push   $0x80108688
801063c3:	e8 f8 a3 ff ff       	call   801007c0 <cprintf>
        return -1;
801063c8:	83 c4 10             	add    $0x10,%esp
801063cb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063d0:	eb c4                	jmp    80106396 <sys_fcopy+0x66>
        cprintf("source file does not exist!\n");
801063d2:	83 ec 0c             	sub    $0xc,%esp
801063d5:	68 69 86 10 80       	push   $0x80108669
801063da:	e8 e1 a3 ff ff       	call   801007c0 <cprintf>
        return -1;
801063df:	83 c4 10             	add    $0x10,%esp
801063e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063e7:	eb ad                	jmp    80106396 <sys_fcopy+0x66>
...
801063f0:	f3 0f 1e fb          	endbr32 
    return fork();
801063f4:	e9 b7 e2 ff ff       	jmp    801046b0 <fork>
...
80106407:	83 ec 08             	sub    $0x8,%esp
    exit();
8010640a:	e8 31 e5 ff ff       	call   80104940 <exit>
...
80106420:	f3 0f 1e fb          	endbr32 
    return wait();
80106424:	e9 67 e7 ff ff       	jmp    80104b90 <wait>
...
80106440:	e8 9b f1 ff ff       	call   801055e0 <argint>
...
80106452:	e8 99 e8 ff ff       	call   80104cf0 <kill>
...
80106477:	83 ec 08             	sub    $0x8,%esp
    return myproc()->pid;
8010647a:	e8 81 e0 ff ff       	call   80104500 <myproc>
...
801064ba:	e8 71 e1 ff ff       	call   80104630 <growproc>
...
801064f1:	e8 ea f0 ff ff       	call   801055e0 <argint>
...
80106504:	68 00 63 11 80       	push   $0x80116300
80106509:	e8 e2 ec ff ff       	call   801051f0 <acquire>
    ticks0 = ticks;
    while (ticks - ticks0 < n) {
8010650e:	8b 55 f4             	mov    -0xc(%ebp),%edx
    ticks0 = ticks;
80106511:	8b 1d 40 6b 11 80    	mov    0x80116b40,%ebx
    while (ticks - ticks0 < n) {
...
80106523:	68 00 63 11 80       	push   $0x80116300
80106528:	68 40 6b 11 80       	push   $0x80116b40
8010652d:	e8 9e e5 ff ff       	call   80104ad0 <sleep>
    while (ticks - ticks0 < n) {
80106532:	a1 40 6b 11 80       	mov    0x80116b40,%eax
...
8010653f:	73 2f                	jae    80106570 <sys_sleep+0x90>
        if (myproc()->killed) {
80106541:	e8 ba df ff ff       	call   80104500 <myproc>
...
80106550:	68 00 63 11 80       	push   $0x80116300
80106555:	e8 56 ed ff ff       	call   801052b0 <release>
    }
    release(&tickslock);
    return 0;
}
...
80106573:	68 00 63 11 80       	push   $0x80116300
80106578:	e8 33 ed ff ff       	call   801052b0 <release>
    return 0;
...
80106598:	83 ec 10             	sub    $0x10,%esp
    ...
    acquire(&tickslock);
8010659b:	68 00 63 11 80       	push   $0x80116300
801065a0:	e8 4b ec ff ff       	call   801051f0 <acquire>
    xticks = ticks;
801065a5:	8b 1d 40 6b 11 80    	mov    0x80116b40,%ebx
    release(&tickslock);
801065ab:	c7 04 24 00 63 11 80 	movl   $0x80116300,(%esp)
801065b2:	e8 f9 ec ff ff       	call   801052b0 <release>
    return xticks;
}
...
801065c0:	f3 0f 1e fb          	endbr32 
    return nuncle();
801065c4:	e9 87 e8 ff ff       	jmp    80104e50 <nuncle>
...
801065d0:	f3 0f 1e fb          	endbr32 
    return ptime();
801065d4:	e9 c7 e8 ff ff       	jmp    80104ea0 <ptime>
...
801065e7:	83 ec 08             	sub    $0x8,%esp
    int n = myproc()->tf->ebx;
801065ea:	e8 11 df ff ff       	call   80104500 <myproc>
    return droot(n);
801065ef:	83 ec 0c             	sub    $0xc,%esp
    int n = myproc()->tf->ebx;
801065f2:	8b 40 18             	mov    0x18(%eax),%eax
    return droot(n);
801065f5:	ff 70 10             	pushl  0x10(%eax)
801065f8:	e8 d3 e8 ff ff       	call   80104ed0 <droot>
801065fd:	c9                   	leave  
801065fe:	c3                   	ret    
...
8010660c:	8e c0                	mov    %eax,%es
  ...
  pushl %esp
8010660e:	54                   	push   %esp
  call trap
8010660f:	e8 cc 00 00 00       	call   801066e0 <trap>
  addl $4, %esp
80106614:	83 c4 04             	add    $0x4,%esp
...
80106617:	61                   	popa   
  popl %gs
80106618:	0f a9                	pop    %gs
  popl %fs
8010661a:	0f a1                	pop    %fs
  popl %es
8010661c:	07                   	pop    %es
  popl %ds
8010661d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010661e:	83 c4 08             	add    $0x8,%esp
  iret
80106621:	cf                   	iret   
...
80106634:	55                   	push   %ebp
    ...
    for (i = 0; i < 256; i++)
80106635:	31 c0                	xor    %eax,%eax
void tvinit(void) {
80106637:	89 e5                	mov    %esp,%ebp
80106639:	83 ec 08             	sub    $0x8,%esp
8010663c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        SETGATE(idt[i], 0, SEG_KCODE << 3, vectors[i], 0);
80106640:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80106647:	c7 04 c5 42 63 11 80 	movl   $0x8e000008,-0x7fee9cbe(,%eax,8)
8010664e:	08 00 00 8e 
80106652:	66 89 14 c5 40 63 11 	mov    %dx,-0x7fee9cc0(,%eax,8)
80106659:	80 
8010665a:	c1 ea 10             	shr    $0x10,%edx
8010665d:	66 89 14 c5 46 63 11 	mov    %dx,-0x7fee9cba(,%eax,8)
80106664:	80 
    for (i = 0; i < 256; i++)
...
8010666f:	83 ec 08             	sub    $0x8,%esp
    SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80106672:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80106677:	c7 05 42 65 11 80 08 	movl   $0xef000008,0x80116542
8010667e:	00 00 ef 
    initlock(&tickslock, "time");
80106681:	68 e7 86 10 80       	push   $0x801086e7
80106686:	68 00 63 11 80       	push   $0x80116300
    SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
8010668b:	66 a3 40 65 11 80    	mov    %ax,0x80116540
80106691:	c1 e8 10             	shr    $0x10,%eax
80106694:	66 a3 46 65 11 80    	mov    %ax,0x80116546
    initlock(&tickslock, "time");
8010669a:	e8 d1 e9 ff ff       	call   80105070 <initlock>
}
...
801066b4:	55                   	push   %ebp
    pd[0] = size - 1;
801066b5:	b8 ff 07 00 00       	mov    $0x7ff,%eax
801066ba:	89 e5                	mov    %esp,%ebp
801066bc:	83 ec 10             	sub    $0x10,%esp
801066bf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
    pd[1] = (uint)p;
801066c3:	b8 40 63 11 80       	mov    $0x80116340,%eax
801066c8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
    pd[2] = (uint)p >> 16;
801066cc:	c1 e8 10             	shr    $0x10,%eax
801066cf:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
    asm volatile("lidt (%0)"
801066d3:	8d 45 fa             	lea    -0x6(%ebp),%eax
801066d6:	0f 01 18             	lidtl  (%eax)
    lidt(idt, sizeof(idt));
}
801066d9:	c9                   	leave  
801066da:	c3                   	ret    
...
801066ea:	83 ec 1c             	sub    $0x1c,%esp
801066ed:	8b 5d 08             	mov    0x8(%ebp),%ebx
    if (tf->trapno == T_SYSCALL) {
801066f0:	8b 43 30             	mov    0x30(%ebx),%eax
801066f3:	83 f8 40             	cmp    $0x40,%eax
801066f6:	0f 84 bc 01 00 00    	je     801068b8 <trap+0x1d8>
        if (myproc()->killed)
            exit();
        return;
    }
    ...
    switch (tf->trapno) {
801066fc:	83 e8 20             	sub    $0x20,%eax
801066ff:	83 f8 1f             	cmp    $0x1f,%eax
80106702:	77 08                	ja     8010670c <trap+0x2c>
80106704:	3e ff 24 85 90 87 10 	notrack jmp *-0x7fef7870(,%eax,4)
8010670b:	80 
        lapiceoi();
        break;
...
8010670c:	e8 ef dd ff ff       	call   80104500 <myproc>
80106711:	8b 7b 38             	mov    0x38(%ebx),%edi
80106714:	85 c0                	test   %eax,%eax
80106716:	0f 84 eb 01 00 00    	je     80106907 <trap+0x227>
8010671c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80106720:	0f 84 e1 01 00 00    	je     80106907 <trap+0x227>
}
...
80106726:	0f 20 d1             	mov    %cr2,%ecx
80106729:	89 4d d8             	mov    %ecx,-0x28(%ebp)
        ...
        cprintf(
8010672c:	e8 af dd ff ff       	call   801044e0 <cpuid>
80106731:	8b 73 30             	mov    0x30(%ebx),%esi
80106734:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106737:	8b 43 34             	mov    0x34(%ebx),%eax
8010673a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "pid %d %s: trap %d err %d on cpu %d "
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010673d:	e8 be dd ff ff       	call   80104500 <myproc>
80106742:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106745:	e8 b6 dd ff ff       	call   80104500 <myproc>
        cprintf(
8010674a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
8010674d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106750:	51                   	push   %ecx
80106751:	57                   	push   %edi
80106752:	52                   	push   %edx
80106753:	ff 75 e4             	pushl  -0x1c(%ebp)
80106756:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80106757:	8b 75 e0             	mov    -0x20(%ebp),%esi
8010675a:	83 c6 6c             	add    $0x6c,%esi
        cprintf(
8010675d:	56                   	push   %esi
8010675e:	ff 70 10             	pushl  0x10(%eax)
80106761:	68 4c 87 10 80       	push   $0x8010874c
80106766:	e8 55 a0 ff ff       	call   801007c0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
        myproc()->killed = 1;
8010676b:	83 c4 20             	add    $0x20,%esp
8010676e:	e8 8d dd ff ff       	call   80104500 <myproc>
80106773:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
    }
...
8010677a:	e8 81 dd ff ff       	call   80104500 <myproc>
8010677f:	85 c0                	test   %eax,%eax
80106781:	74 1d                	je     801067a0 <trap+0xc0>
80106783:	e8 78 dd ff ff       	call   80104500 <myproc>
80106788:	8b 50 24             	mov    0x24(%eax),%edx
8010678b:	85 d2                	test   %edx,%edx
8010678d:	74 11                	je     801067a0 <trap+0xc0>
8010678f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80106793:	83 e0 03             	and    $0x3,%eax
80106796:	66 83 f8 03          	cmp    $0x3,%ax
8010679a:	0f 84 50 01 00 00    	je     801068f0 <trap+0x210>
        exit();

    // Force process to give up CPU on clock tick.
    // If interrupts were on while locks held, would need to check nlock.
    if (myproc() && myproc()->state == RUNNING &&
801067a0:	e8 5b dd ff ff       	call   80104500 <myproc>
801067a5:	85 c0                	test   %eax,%eax
801067a7:	74 0f                	je     801067b8 <trap+0xd8>
801067a9:	e8 52 dd ff ff       	call   80104500 <myproc>
801067ae:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801067b2:	0f 84 e8 00 00 00    	je     801068a0 <trap+0x1c0>
        tf->trapno == T_IRQ0 + IRQ_TIMER)
        yield();

    // Check if the process has been killed since we yielded
    if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
801067b8:	e8 43 dd ff ff       	call   80104500 <myproc>
801067bd:	85 c0                	test   %eax,%eax
801067bf:	74 1d                	je     801067de <trap+0xfe>
801067c1:	e8 3a dd ff ff       	call   80104500 <myproc>
801067c6:	8b 40 24             	mov    0x24(%eax),%eax
801067c9:	85 c0                	test   %eax,%eax
801067cb:	74 11                	je     801067de <trap+0xfe>
801067cd:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801067d1:	83 e0 03             	and    $0x3,%eax
801067d4:	66 83 f8 03          	cmp    $0x3,%ax
801067d8:	0f 84 03 01 00 00    	je     801068e1 <trap+0x201>
        exit();
}
...
801067e5:	c3                   	ret    
        ideintr();
801067e6:	e8 95 c5 ff ff       	call   80102d80 <ideintr>
        lapiceoi();
801067eb:	e8 70 cc ff ff       	call   80103460 <lapiceoi>
    if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
801067f0:	e8 0b dd ff ff       	call   80104500 <myproc>
801067f5:	85 c0                	test   %eax,%eax
801067f7:	75 8a                	jne    80106783 <trap+0xa3>
801067f9:	eb a5                	jmp    801067a0 <trap+0xc0>
        if (cpuid() == 0) {
801067fb:	e8 e0 dc ff ff       	call   801044e0 <cpuid>
80106800:	85 c0                	test   %eax,%eax
80106802:	75 e7                	jne    801067eb <trap+0x10b>
            acquire(&tickslock);
80106804:	83 ec 0c             	sub    $0xc,%esp
80106807:	68 00 63 11 80       	push   $0x80116300
8010680c:	e8 df e9 ff ff       	call   801051f0 <acquire>
            wakeup(&ticks);
80106811:	c7 04 24 40 6b 11 80 	movl   $0x80116b40,(%esp)
            ticks++;
80106818:	83 05 40 6b 11 80 01 	addl   $0x1,0x80116b40
            wakeup(&ticks);
8010681f:	e8 6c e4 ff ff       	call   80104c90 <wakeup>
            release(&tickslock);
80106824:	c7 04 24 00 63 11 80 	movl   $0x80116300,(%esp)
8010682b:	e8 80 ea ff ff       	call   801052b0 <release>
80106830:	83 c4 10             	add    $0x10,%esp
        lapiceoi();
80106833:	eb b6                	jmp    801067eb <trap+0x10b>
        kbdintr();
80106835:	e8 e6 ca ff ff       	call   80103320 <kbdintr>
        lapiceoi();
8010683a:	e8 21 cc ff ff       	call   80103460 <lapiceoi>
    if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
8010683f:	e8 bc dc ff ff       	call   80104500 <myproc>
80106844:	85 c0                	test   %eax,%eax
80106846:	0f 85 37 ff ff ff    	jne    80106783 <trap+0xa3>
8010684c:	e9 4f ff ff ff       	jmp    801067a0 <trap+0xc0>
        uartintr();
80106851:	e8 4a 02 00 00       	call   80106aa0 <uartintr>
        lapiceoi();
80106856:	e8 05 cc ff ff       	call   80103460 <lapiceoi>
    if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
8010685b:	e8 a0 dc ff ff       	call   80104500 <myproc>
80106860:	85 c0                	test   %eax,%eax
80106862:	0f 85 1b ff ff ff    	jne    80106783 <trap+0xa3>
80106868:	e9 33 ff ff ff       	jmp    801067a0 <trap+0xc0>
        cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010686d:	8b 7b 38             	mov    0x38(%ebx),%edi
80106870:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106874:	e8 67 dc ff ff       	call   801044e0 <cpuid>
80106879:	57                   	push   %edi
8010687a:	56                   	push   %esi
8010687b:	50                   	push   %eax
8010687c:	68 f4 86 10 80       	push   $0x801086f4
80106881:	e8 3a 9f ff ff       	call   801007c0 <cprintf>
        lapiceoi();
80106886:	e8 d5 cb ff ff       	call   80103460 <lapiceoi>
        break;
8010688b:	83 c4 10             	add    $0x10,%esp
    if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
8010688e:	e8 6d dc ff ff       	call   80104500 <myproc>
80106893:	85 c0                	test   %eax,%eax
80106895:	0f 85 e8 fe ff ff    	jne    80106783 <trap+0xa3>
8010689b:	e9 00 ff ff ff       	jmp    801067a0 <trap+0xc0>
    if (myproc() && myproc()->state == RUNNING &&
801068a0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801068a4:	0f 85 0e ff ff ff    	jne    801067b8 <trap+0xd8>
        yield();
801068aa:	e8 d1 e1 ff ff       	call   80104a80 <yield>
801068af:	e9 04 ff ff ff       	jmp    801067b8 <trap+0xd8>
801068b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if (myproc()->killed)
801068b8:	e8 43 dc ff ff       	call   80104500 <myproc>
801068bd:	8b 70 24             	mov    0x24(%eax),%esi
801068c0:	85 f6                	test   %esi,%esi
801068c2:	75 3c                	jne    80106900 <trap+0x220>
        myproc()->tf = tf;
801068c4:	e8 37 dc ff ff       	call   80104500 <myproc>
801068c9:	89 58 18             	mov    %ebx,0x18(%eax)
        syscall();
801068cc:	e8 ff ed ff ff       	call   801056d0 <syscall>
        if (myproc()->killed)
801068d1:	e8 2a dc ff ff       	call   80104500 <myproc>
801068d6:	8b 48 24             	mov    0x24(%eax),%ecx
801068d9:	85 c9                	test   %ecx,%ecx
801068db:	0f 84 fd fe ff ff    	je     801067de <trap+0xfe>
}
...
801068e7:	5d                   	pop    %ebp
            exit();
801068e8:	e9 53 e0 ff ff       	jmp    80104940 <exit>
801068ed:	8d 76 00             	lea    0x0(%esi),%esi
        exit();
801068f0:	e8 4b e0 ff ff       	call   80104940 <exit>
801068f5:	e9 a6 fe ff ff       	jmp    801067a0 <trap+0xc0>
801068fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            exit();
80106900:	e8 3b e0 ff ff       	call   80104940 <exit>
80106905:	eb bd                	jmp    801068c4 <trap+0x1e4>
80106907:	0f 20 d6             	mov    %cr2,%esi
            cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010690a:	e8 d1 db ff ff       	call   801044e0 <cpuid>
8010690f:	83 ec 0c             	sub    $0xc,%esp
80106912:	56                   	push   %esi
80106913:	57                   	push   %edi
80106914:	50                   	push   %eax
80106915:	ff 73 30             	pushl  0x30(%ebx)
80106918:	68 18 87 10 80       	push   $0x80108718
8010691d:	e8 9e 9e ff ff       	call   801007c0 <cprintf>
            panic("trap");
80106922:	83 c4 14             	add    $0x14,%esp
80106925:	68 ec 86 10 80       	push   $0x801086ec
8010692a:	e8 61 9a ff ff       	call   80100390 <panic>
8010692f:	90                   	nop
...
80106930:	f3 0f 1e fb          	endbr32 
    if (!uart)
80106934:	a1 bc b5 10 80       	mov    0x8010b5bc,%eax
80106939:	85 c0                	test   %eax,%eax
8010693b:	74 1b                	je     80106958 <uartgetc+0x28>
    asm volatile("in %1,%0"
8010693d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106942:	ec                   	in     (%dx),%al
        return -1;
    if (!(inb(COM1 + 5) & 0x01))
80106943:	a8 01                	test   $0x1,%al
80106945:	74 11                	je     80106958 <uartgetc+0x28>
80106947:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010694c:	ec                   	in     (%dx),%al
        return -1;
    return inb(COM1 + 0);
8010694d:	0f b6 c0             	movzbl %al,%eax
80106950:	c3                   	ret    
...
80106985:	e8 f6 ca ff ff       	call   80103480 <microdelay>
    for (i = 0; i < 128 && !(inb(COM1 + 5) & 0x20); i++)
8010698a:	83 c4 10             	add    $0x10,%esp
8010698d:	83 eb 01             	sub    $0x1,%ebx
80106990:	74 07                	je     80106999 <uartputc.part.0+0x39>
80106992:	89 f2                	mov    %esi,%edx
80106994:	ec                   	in     (%dx),%al
80106995:	a8 20                	test   $0x20,%al
80106997:	74 e7                	je     80106980 <uartputc.part.0+0x20>
    asm volatile("out %0,%1"
80106999:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010699e:	89 f8                	mov    %edi,%eax
801069a0:	ee                   	out    %al,(%dx)
}
...
801069b7:	89 c8                	mov    %ecx,%eax
801069b9:	89 e5                	mov    %esp,%ebp
801069bb:	57                   	push   %edi
801069bc:	56                   	push   %esi
801069bd:	53                   	push   %ebx
801069be:	bb fa 03 00 00       	mov    $0x3fa,%ebx
801069c3:	89 da                	mov    %ebx,%edx
801069c5:	83 ec 0c             	sub    $0xc,%esp
801069c8:	ee                   	out    %al,(%dx)
801069c9:	bf fb 03 00 00       	mov    $0x3fb,%edi
801069ce:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801069d3:	89 fa                	mov    %edi,%edx
801069d5:	ee                   	out    %al,(%dx)
801069d6:	b8 0c 00 00 00       	mov    $0xc,%eax
801069db:	ba f8 03 00 00       	mov    $0x3f8,%edx
801069e0:	ee                   	out    %al,(%dx)
801069e1:	be f9 03 00 00       	mov    $0x3f9,%esi
801069e6:	89 c8                	mov    %ecx,%eax
801069e8:	89 f2                	mov    %esi,%edx
801069ea:	ee                   	out    %al,(%dx)
801069eb:	b8 03 00 00 00       	mov    $0x3,%eax
801069f0:	89 fa                	mov    %edi,%edx
801069f2:	ee                   	out    %al,(%dx)
801069f3:	ba fc 03 00 00       	mov    $0x3fc,%edx
801069f8:	89 c8                	mov    %ecx,%eax
801069fa:	ee                   	out    %al,(%dx)
801069fb:	b8 01 00 00 00       	mov    $0x1,%eax
80106a00:	89 f2                	mov    %esi,%edx
80106a02:	ee                   	out    %al,(%dx)
    asm volatile("in %1,%0"
80106a03:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106a08:	ec                   	in     (%dx),%al
    if (inb(COM1 + 5) == 0xFF)
80106a09:	3c ff                	cmp    $0xff,%al
80106a0b:	74 52                	je     80106a5f <uartinit+0xaf>
    uart = 1;
80106a0d:	c7 05 bc b5 10 80 01 	movl   $0x1,0x8010b5bc
80106a14:	00 00 00 
80106a17:	89 da                	mov    %ebx,%edx
80106a19:	ec                   	in     (%dx),%al
80106a1a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106a1f:	ec                   	in     (%dx),%al
    ioapicenable(IRQ_COM1, 0);
80106a20:	83 ec 08             	sub    $0x8,%esp
80106a23:	be 76 00 00 00       	mov    $0x76,%esi
    for (p = "xv6...\n"; *p; p++)
80106a28:	bb 10 88 10 80       	mov    $0x80108810,%ebx
    ioapicenable(IRQ_COM1, 0);
80106a2d:	6a 00                	push   $0x0
80106a2f:	6a 04                	push   $0x4
80106a31:	e8 9a c5 ff ff       	call   80102fd0 <ioapicenable>
80106a36:	83 c4 10             	add    $0x10,%esp
    for (p = "xv6...\n"; *p; p++)
80106a39:	b8 78 00 00 00       	mov    $0x78,%eax
80106a3e:	eb 04                	jmp    80106a44 <uartinit+0x94>
80106a40:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
    if (!uart)
80106a44:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
80106a4a:	85 d2                	test   %edx,%edx
80106a4c:	74 08                	je     80106a56 <uartinit+0xa6>
        uartputc(*p);
80106a4e:	0f be c0             	movsbl %al,%eax
80106a51:	e8 0a ff ff ff       	call   80106960 <uartputc.part.0>
    for (p = "xv6...\n"; *p; p++)
80106a56:	89 f0                	mov    %esi,%eax
80106a58:	83 c3 01             	add    $0x1,%ebx
80106a5b:	84 c0                	test   %al,%al
80106a5d:	75 e1                	jne    80106a40 <uartinit+0x90>
}
80106a5f:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106a62:	5b                   	pop    %ebx
80106a63:	5e                   	pop    %esi
80106a64:	5f                   	pop    %edi
80106a65:	5d                   	pop    %ebp
...
80106a74:	55                   	push   %ebp
    if (!uart)
80106a75:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
void uartputc(int c) {
80106a7b:	89 e5                	mov    %esp,%ebp
80106a7d:	8b 45 08             	mov    0x8(%ebp),%eax
    if (!uart)
80106a80:	85 d2                	test   %edx,%edx
80106a82:	74 0c                	je     80106a90 <uartputc+0x20>
}
80106a84:	5d                   	pop    %ebp
80106a85:	e9 d6 fe ff ff       	jmp    80106960 <uartputc.part.0>
...
80106aaa:	68 30 69 10 80       	push   $0x80106930
80106aaf:	e8 1c 9f ff ff       	call   801009d0 <consoleintr>
}
...
80106abb:	6a 00                	push   $0x0
  jmp alltraps
80106abd:	e9 3d fb ff ff       	jmp    801065ff <alltraps>
...
80106ac4:	6a 01                	push   $0x1
  jmp alltraps
80106ac6:	e9 34 fb ff ff       	jmp    801065ff <alltraps>
...
80106acd:	6a 02                	push   $0x2
  jmp alltraps
80106acf:	e9 2b fb ff ff       	jmp    801065ff <alltraps>
...
80106ad6:	6a 03                	push   $0x3
  jmp alltraps
80106ad8:	e9 22 fb ff ff       	jmp    801065ff <alltraps>
...
80106adf:	6a 04                	push   $0x4
  jmp alltraps
80106ae1:	e9 19 fb ff ff       	jmp    801065ff <alltraps>
...
80106ae8:	6a 05                	push   $0x5
  jmp alltraps
80106aea:	e9 10 fb ff ff       	jmp    801065ff <alltraps>
...
80106af1:	6a 06                	push   $0x6
  jmp alltraps
80106af3:	e9 07 fb ff ff       	jmp    801065ff <alltraps>
...
80106afa:	6a 07                	push   $0x7
  jmp alltraps
80106afc:	e9 fe fa ff ff       	jmp    801065ff <alltraps>
...
80106b01:	6a 08                	push   $0x8
  jmp alltraps
80106b03:	e9 f7 fa ff ff       	jmp    801065ff <alltraps>
...
80106b0a:	6a 09                	push   $0x9
  jmp alltraps
80106b0c:	e9 ee fa ff ff       	jmp    801065ff <alltraps>
...
80106b11:	6a 0a                	push   $0xa
  jmp alltraps
80106b13:	e9 e7 fa ff ff       	jmp    801065ff <alltraps>
...
80106b18:	6a 0b                	push   $0xb
  jmp alltraps
80106b1a:	e9 e0 fa ff ff       	jmp    801065ff <alltraps>
...
80106b1f:	6a 0c                	push   $0xc
  jmp alltraps
80106b21:	e9 d9 fa ff ff       	jmp    801065ff <alltraps>
...
80106b26:	6a 0d                	push   $0xd
  jmp alltraps
80106b28:	e9 d2 fa ff ff       	jmp    801065ff <alltraps>
...
80106b2d:	6a 0e                	push   $0xe
  jmp alltraps
80106b2f:	e9 cb fa ff ff       	jmp    801065ff <alltraps>
...
80106b36:	6a 0f                	push   $0xf
  jmp alltraps
80106b38:	e9 c2 fa ff ff       	jmp    801065ff <alltraps>
...
80106b3f:	6a 10                	push   $0x10
  jmp alltraps
80106b41:	e9 b9 fa ff ff       	jmp    801065ff <alltraps>
...
80106b46:	6a 11                	push   $0x11
  jmp alltraps
80106b48:	e9 b2 fa ff ff       	jmp    801065ff <alltraps>
...
80106b4f:	6a 12                	push   $0x12
  jmp alltraps
80106b51:	e9 a9 fa ff ff       	jmp    801065ff <alltraps>
...
80106b58:	6a 13                	push   $0x13
  jmp alltraps
80106b5a:	e9 a0 fa ff ff       	jmp    801065ff <alltraps>
...
80106b61:	6a 14                	push   $0x14
  jmp alltraps
80106b63:	e9 97 fa ff ff       	jmp    801065ff <alltraps>
...
80106b6a:	6a 15                	push   $0x15
  jmp alltraps
80106b6c:	e9 8e fa ff ff       	jmp    801065ff <alltraps>
...
80106b73:	6a 16                	push   $0x16
  jmp alltraps
80106b75:	e9 85 fa ff ff       	jmp    801065ff <alltraps>
...
80106b7c:	6a 17                	push   $0x17
  jmp alltraps
80106b7e:	e9 7c fa ff ff       	jmp    801065ff <alltraps>
...
80106b85:	6a 18                	push   $0x18
  jmp alltraps
80106b87:	e9 73 fa ff ff       	jmp    801065ff <alltraps>
...
80106b8e:	6a 19                	push   $0x19
  jmp alltraps
80106b90:	e9 6a fa ff ff       	jmp    801065ff <alltraps>
...
80106b97:	6a 1a                	push   $0x1a
  jmp alltraps
80106b99:	e9 61 fa ff ff       	jmp    801065ff <alltraps>
...
80106ba0:	6a 1b                	push   $0x1b
  jmp alltraps
80106ba2:	e9 58 fa ff ff       	jmp    801065ff <alltraps>
...
80106ba9:	6a 1c                	push   $0x1c
  jmp alltraps
80106bab:	e9 4f fa ff ff       	jmp    801065ff <alltraps>
...
80106bb2:	6a 1d                	push   $0x1d
  jmp alltraps
80106bb4:	e9 46 fa ff ff       	jmp    801065ff <alltraps>
...
80106bbb:	6a 1e                	push   $0x1e
  jmp alltraps
80106bbd:	e9 3d fa ff ff       	jmp    801065ff <alltraps>
...
80106bc4:	6a 1f                	push   $0x1f
  jmp alltraps
80106bc6:	e9 34 fa ff ff       	jmp    801065ff <alltraps>
...
80106bcd:	6a 20                	push   $0x20
  jmp alltraps
80106bcf:	e9 2b fa ff ff       	jmp    801065ff <alltraps>
...
80106bd6:	6a 21                	push   $0x21
  jmp alltraps
80106bd8:	e9 22 fa ff ff       	jmp    801065ff <alltraps>
...
80106bdf:	6a 22                	push   $0x22
  jmp alltraps
80106be1:	e9 19 fa ff ff       	jmp    801065ff <alltraps>
...
80106be8:	6a 23                	push   $0x23
  jmp alltraps
80106bea:	e9 10 fa ff ff       	jmp    801065ff <alltraps>
...
80106bf1:	6a 24                	push   $0x24
  jmp alltraps
80106bf3:	e9 07 fa ff ff       	jmp    801065ff <alltraps>
...
80106bfa:	6a 25                	push   $0x25
  jmp alltraps
80106bfc:	e9 fe f9 ff ff       	jmp    801065ff <alltraps>
...
80106c03:	6a 26                	push   $0x26
  jmp alltraps
80106c05:	e9 f5 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c0c:	6a 27                	push   $0x27
  jmp alltraps
80106c0e:	e9 ec f9 ff ff       	jmp    801065ff <alltraps>
...
80106c15:	6a 28                	push   $0x28
  jmp alltraps
80106c17:	e9 e3 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c1e:	6a 29                	push   $0x29
  jmp alltraps
80106c20:	e9 da f9 ff ff       	jmp    801065ff <alltraps>
...
80106c27:	6a 2a                	push   $0x2a
  jmp alltraps
80106c29:	e9 d1 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c30:	6a 2b                	push   $0x2b
  jmp alltraps
80106c32:	e9 c8 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c39:	6a 2c                	push   $0x2c
  jmp alltraps
80106c3b:	e9 bf f9 ff ff       	jmp    801065ff <alltraps>
...
80106c42:	6a 2d                	push   $0x2d
  jmp alltraps
80106c44:	e9 b6 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c4b:	6a 2e                	push   $0x2e
  jmp alltraps
80106c4d:	e9 ad f9 ff ff       	jmp    801065ff <alltraps>
...
80106c54:	6a 2f                	push   $0x2f
  jmp alltraps
80106c56:	e9 a4 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c5d:	6a 30                	push   $0x30
  jmp alltraps
80106c5f:	e9 9b f9 ff ff       	jmp    801065ff <alltraps>
...
80106c66:	6a 31                	push   $0x31
  jmp alltraps
80106c68:	e9 92 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c6f:	6a 32                	push   $0x32
  jmp alltraps
80106c71:	e9 89 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c78:	6a 33                	push   $0x33
  jmp alltraps
80106c7a:	e9 80 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c81:	6a 34                	push   $0x34
  jmp alltraps
80106c83:	e9 77 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c8a:	6a 35                	push   $0x35
  jmp alltraps
80106c8c:	e9 6e f9 ff ff       	jmp    801065ff <alltraps>
...
80106c93:	6a 36                	push   $0x36
  jmp alltraps
80106c95:	e9 65 f9 ff ff       	jmp    801065ff <alltraps>
...
80106c9c:	6a 37                	push   $0x37
  jmp alltraps
80106c9e:	e9 5c f9 ff ff       	jmp    801065ff <alltraps>
...
80106ca5:	6a 38                	push   $0x38
  jmp alltraps
80106ca7:	e9 53 f9 ff ff       	jmp    801065ff <alltraps>
...
80106cae:	6a 39                	push   $0x39
  jmp alltraps
80106cb0:	e9 4a f9 ff ff       	jmp    801065ff <alltraps>
...
80106cb7:	6a 3a                	push   $0x3a
  jmp alltraps
80106cb9:	e9 41 f9 ff ff       	jmp    801065ff <alltraps>
...
80106cd2:	6a 3d                	push   $0x3d
  jmp alltraps
80106cd4:	e9 26 f9 ff ff       	jmp    801065ff <alltraps>
...
80106cdb:	6a 3e                	push   $0x3e
  jmp alltraps
80106cdd:	e9 1d f9 ff ff       	jmp    801065ff <alltraps>
...
80106ce4:	6a 3f                	push   $0x3f
  jmp alltraps
80106ce6:	e9 14 f9 ff ff       	jmp    801065ff <alltraps>
...
80106ced:	6a 40                	push   $0x40
  jmp alltraps
80106cef:	e9 0b f9 ff ff       	jmp    801065ff <alltraps>
...
80106cf6:	6a 41                	push   $0x41
  jmp alltraps
80106cf8:	e9 02 f9 ff ff       	jmp    801065ff <alltraps>
...
80106cff:	6a 42                	push   $0x42
  jmp alltraps
80106d01:	e9 f9 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d08:	6a 43                	push   $0x43
  jmp alltraps
80106d0a:	e9 f0 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d11:	6a 44                	push   $0x44
  jmp alltraps
80106d13:	e9 e7 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d1a:	6a 45                	push   $0x45
  jmp alltraps
80106d1c:	e9 de f8 ff ff       	jmp    801065ff <alltraps>
...
80106d23:	6a 46                	push   $0x46
  jmp alltraps
80106d25:	e9 d5 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d2c:	6a 47                	push   $0x47
  jmp alltraps
80106d2e:	e9 cc f8 ff ff       	jmp    801065ff <alltraps>
...
80106d35:	6a 48                	push   $0x48
  jmp alltraps
80106d37:	e9 c3 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d3e:	6a 49                	push   $0x49
  jmp alltraps
80106d40:	e9 ba f8 ff ff       	jmp    801065ff <alltraps>
...
80106d47:	6a 4a                	push   $0x4a
  jmp alltraps
80106d49:	e9 b1 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d50:	6a 4b                	push   $0x4b
  jmp alltraps
80106d52:	e9 a8 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d59:	6a 4c                	push   $0x4c
  jmp alltraps
80106d5b:	e9 9f f8 ff ff       	jmp    801065ff <alltraps>
...
80106d62:	6a 4d                	push   $0x4d
  jmp alltraps
80106d64:	e9 96 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d6b:	6a 4e                	push   $0x4e
  jmp alltraps
80106d6d:	e9 8d f8 ff ff       	jmp    801065ff <alltraps>
...
80106d74:	6a 4f                	push   $0x4f
  jmp alltraps
80106d76:	e9 84 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d7d:	6a 50                	push   $0x50
  jmp alltraps
80106d7f:	e9 7b f8 ff ff       	jmp    801065ff <alltraps>
...
80106d86:	6a 51                	push   $0x51
  jmp alltraps
80106d88:	e9 72 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d8f:	6a 52                	push   $0x52
  jmp alltraps
80106d91:	e9 69 f8 ff ff       	jmp    801065ff <alltraps>
...
80106d98:	6a 53                	push   $0x53
  jmp alltraps
80106d9a:	e9 60 f8 ff ff       	jmp    801065ff <alltraps>
...
80106da1:	6a 54                	push   $0x54
  jmp alltraps
80106da3:	e9 57 f8 ff ff       	jmp    801065ff <alltraps>
...
80106daa:	6a 55                	push   $0x55
  jmp alltraps
80106dac:	e9 4e f8 ff ff       	jmp    801065ff <alltraps>
...
80106db3:	6a 56                	push   $0x56
  jmp alltraps
80106db5:	e9 45 f8 ff ff       	jmp    801065ff <alltraps>
...
80106dbc:	6a 57                	push   $0x57
  jmp alltraps
80106dbe:	e9 3c f8 ff ff       	jmp    801065ff <alltraps>
...
80106dc5:	6a 58                	push   $0x58
  jmp alltraps
80106dc7:	e9 33 f8 ff ff       	jmp    801065ff <alltraps>
...
80106dce:	6a 59                	push   $0x59
  jmp alltraps
80106dd0:	e9 2a f8 ff ff       	jmp    801065ff <alltraps>
...
80106dd7:	6a 5a                	push   $0x5a
  jmp alltraps
80106dd9:	e9 21 f8 ff ff       	jmp    801065ff <alltraps>
...
80106de0:	6a 5b                	push   $0x5b
  jmp alltraps
80106de2:	e9 18 f8 ff ff       	jmp    801065ff <alltraps>
...
80106de9:	6a 5c                	push   $0x5c
  jmp alltraps
80106deb:	e9 0f f8 ff ff       	jmp    801065ff <alltraps>
...
80106df2:	6a 5d                	push   $0x5d
  jmp alltraps
80106df4:	e9 06 f8 ff ff       	jmp    801065ff <alltraps>
...
80106dfb:	6a 5e                	push   $0x5e
  jmp alltraps
80106dfd:	e9 fd f7 ff ff       	jmp    801065ff <alltraps>
...
80106e04:	6a 5f                	push   $0x5f
  jmp alltraps
80106e06:	e9 f4 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e0d:	6a 60                	push   $0x60
  jmp alltraps
80106e0f:	e9 eb f7 ff ff       	jmp    801065ff <alltraps>
...
80106e16:	6a 61                	push   $0x61
  jmp alltraps
80106e18:	e9 e2 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e1f:	6a 62                	push   $0x62
  jmp alltraps
80106e21:	e9 d9 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e28:	6a 63                	push   $0x63
  jmp alltraps
80106e2a:	e9 d0 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e31:	6a 64                	push   $0x64
  jmp alltraps
80106e33:	e9 c7 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e3a:	6a 65                	push   $0x65
  jmp alltraps
80106e3c:	e9 be f7 ff ff       	jmp    801065ff <alltraps>
...
80106e43:	6a 66                	push   $0x66
  jmp alltraps
80106e45:	e9 b5 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e4c:	6a 67                	push   $0x67
  jmp alltraps
80106e4e:	e9 ac f7 ff ff       	jmp    801065ff <alltraps>
...
80106e55:	6a 68                	push   $0x68
  jmp alltraps
80106e57:	e9 a3 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e5e:	6a 69                	push   $0x69
  jmp alltraps
80106e60:	e9 9a f7 ff ff       	jmp    801065ff <alltraps>
...
80106e67:	6a 6a                	push   $0x6a
  jmp alltraps
80106e69:	e9 91 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e70:	6a 6b                	push   $0x6b
  jmp alltraps
80106e72:	e9 88 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e79:	6a 6c                	push   $0x6c
  jmp alltraps
80106e7b:	e9 7f f7 ff ff       	jmp    801065ff <alltraps>
...
80106e82:	6a 6d                	push   $0x6d
  jmp alltraps
80106e84:	e9 76 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e8b:	6a 6e                	push   $0x6e
  jmp alltraps
80106e8d:	e9 6d f7 ff ff       	jmp    801065ff <alltraps>
...
80106e94:	6a 6f                	push   $0x6f
  jmp alltraps
80106e96:	e9 64 f7 ff ff       	jmp    801065ff <alltraps>
...
80106e9d:	6a 70                	push   $0x70
  jmp alltraps
80106e9f:	e9 5b f7 ff ff       	jmp    801065ff <alltraps>
...
80106ea6:	6a 71                	push   $0x71
  jmp alltraps
80106ea8:	e9 52 f7 ff ff       	jmp    801065ff <alltraps>
...
80106eaf:	6a 72                	push   $0x72
  jmp alltraps
80106eb1:	e9 49 f7 ff ff       	jmp    801065ff <alltraps>
...
80106eb8:	6a 73                	push   $0x73
  jmp alltraps
80106eba:	e9 40 f7 ff ff       	jmp    801065ff <alltraps>
...
80106ec1:	6a 74                	push   $0x74
  jmp alltraps
80106ec3:	e9 37 f7 ff ff       	jmp    801065ff <alltraps>
...
80106eca:	6a 75                	push   $0x75
  jmp alltraps
80106ecc:	e9 2e f7 ff ff       	jmp    801065ff <alltraps>
...
80106ed3:	6a 76                	push   $0x76
  jmp alltraps
80106ed5:	e9 25 f7 ff ff       	jmp    801065ff <alltraps>
...
80106edc:	6a 77                	push   $0x77
  jmp alltraps
80106ede:	e9 1c f7 ff ff       	jmp    801065ff <alltraps>
...
80106ee5:	6a 78                	push   $0x78
  jmp alltraps
80106ee7:	e9 13 f7 ff ff       	jmp    801065ff <alltraps>
...
80106eee:	6a 79                	push   $0x79
  jmp alltraps
80106ef0:	e9 0a f7 ff ff       	jmp    801065ff <alltraps>
...
80106ef7:	6a 7a                	push   $0x7a
  jmp alltraps
80106ef9:	e9 01 f7 ff ff       	jmp    801065ff <alltraps>
...
80106f00:	6a 7b                	push   $0x7b
  jmp alltraps
80106f02:	e9 f8 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f09:	6a 7c                	push   $0x7c
  jmp alltraps
80106f0b:	e9 ef f6 ff ff       	jmp    801065ff <alltraps>
...
80106f12:	6a 7d                	push   $0x7d
  jmp alltraps
80106f14:	e9 e6 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f1b:	6a 7e                	push   $0x7e
  jmp alltraps
80106f1d:	e9 dd f6 ff ff       	jmp    801065ff <alltraps>
...
80106f24:	6a 7f                	push   $0x7f
  jmp alltraps
80106f26:	e9 d4 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f2d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106f32:	e9 c8 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f45:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106f4a:	e9 b0 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f51:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106f56:	e9 a4 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f69:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106f6e:	e9 8c f6 ff ff       	jmp    801065ff <alltraps>
...
80106f75:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106f7a:	e9 80 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f8d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106f92:	e9 68 f6 ff ff       	jmp    801065ff <alltraps>
...
80106f99:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106f9e:	e9 5c f6 ff ff       	jmp    801065ff <alltraps>
...
80106fb1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106fb6:	e9 44 f6 ff ff       	jmp    801065ff <alltraps>
...
80106fbd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106fc2:	e9 38 f6 ff ff       	jmp    801065ff <alltraps>
...
80106fd5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106fda:	e9 20 f6 ff ff       	jmp    801065ff <alltraps>
...
80106fe1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106fe6:	e9 14 f6 ff ff       	jmp    801065ff <alltraps>
...
80106ff9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106ffe:	e9 fc f5 ff ff       	jmp    801065ff <alltraps>
...
80107005:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010700a:	e9 f0 f5 ff ff       	jmp    801065ff <alltraps>
...
8010701d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107022:	e9 d8 f5 ff ff       	jmp    801065ff <alltraps>
...
80107029:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010702e:	e9 cc f5 ff ff       	jmp    801065ff <alltraps>
...
80107041:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107046:	e9 b4 f5 ff ff       	jmp    801065ff <alltraps>
...
8010704d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107052:	e9 a8 f5 ff ff       	jmp    801065ff <alltraps>
...
80107065:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010706a:	e9 90 f5 ff ff       	jmp    801065ff <alltraps>
...
80107071:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107076:	e9 84 f5 ff ff       	jmp    801065ff <alltraps>
...
80107089:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010708e:	e9 6c f5 ff ff       	jmp    801065ff <alltraps>
...
80107095:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010709a:	e9 60 f5 ff ff       	jmp    801065ff <alltraps>
...
801070ad:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801070b2:	e9 48 f5 ff ff       	jmp    801065ff <alltraps>
...
801070b9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801070be:	e9 3c f5 ff ff       	jmp    801065ff <alltraps>
...
801070d1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801070d6:	e9 24 f5 ff ff       	jmp    801065ff <alltraps>
...
801070dd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801070e2:	e9 18 f5 ff ff       	jmp    801065ff <alltraps>
...
801070e9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801070ee:	e9 0c f5 ff ff       	jmp    801065ff <alltraps>
...
801070f5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801070fa:	e9 00 f5 ff ff       	jmp    801065ff <alltraps>
...
80107101:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107106:	e9 f4 f4 ff ff       	jmp    801065ff <alltraps>
...
8010710d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107112:	e9 e8 f4 ff ff       	jmp    801065ff <alltraps>
...
80107119:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010711e:	e9 dc f4 ff ff       	jmp    801065ff <alltraps>
...
80107125:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010712a:	e9 d0 f4 ff ff       	jmp    801065ff <alltraps>
...
80107131:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107136:	e9 c4 f4 ff ff       	jmp    801065ff <alltraps>
...
8010713d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107142:	e9 b8 f4 ff ff       	jmp    801065ff <alltraps>
...
80107149:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010714e:	e9 ac f4 ff ff       	jmp    801065ff <alltraps>
...
80107155:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010715a:	e9 a0 f4 ff ff       	jmp    801065ff <alltraps>
...
80107161:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107166:	e9 94 f4 ff ff       	jmp    801065ff <alltraps>
...
8010716d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107172:	e9 88 f4 ff ff       	jmp    801065ff <alltraps>
...
80107179:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010717e:	e9 7c f4 ff ff       	jmp    801065ff <alltraps>
...
80107185:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010718a:	e9 70 f4 ff ff       	jmp    801065ff <alltraps>
...
80107191:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107196:	e9 64 f4 ff ff       	jmp    801065ff <alltraps>
...
8010719d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801071a2:	e9 58 f4 ff ff       	jmp    801065ff <alltraps>
...
801071a9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801071ae:	e9 4c f4 ff ff       	jmp    801065ff <alltraps>
...
801071b5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801071ba:	e9 40 f4 ff ff       	jmp    801065ff <alltraps>
...
801071c1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801071c6:	e9 34 f4 ff ff       	jmp    801065ff <alltraps>
...
801071cd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801071d2:	e9 28 f4 ff ff       	jmp    801065ff <alltraps>
...
801071d9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801071de:	e9 1c f4 ff ff       	jmp    801065ff <alltraps>
...
801071e5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801071ea:	e9 10 f4 ff ff       	jmp    801065ff <alltraps>
...
801071f1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801071f6:	e9 04 f4 ff ff       	jmp    801065ff <alltraps>
...
801071fd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107202:	e9 f8 f3 ff ff       	jmp    801065ff <alltraps>
...
80107209:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010720e:	e9 ec f3 ff ff       	jmp    801065ff <alltraps>
...
80107215:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010721a:	e9 e0 f3 ff ff       	jmp    801065ff <alltraps>
...
80107221:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107226:	e9 d4 f3 ff ff       	jmp    801065ff <alltraps>
...
8010722d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107232:	e9 c8 f3 ff ff       	jmp    801065ff <alltraps>
...
80107239:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010723e:	e9 bc f3 ff ff       	jmp    801065ff <alltraps>
...
80107245:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010724a:	e9 b0 f3 ff ff       	jmp    801065ff <alltraps>
...
80107251:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107256:	e9 a4 f3 ff ff       	jmp    801065ff <alltraps>
...
8010725d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107262:	e9 98 f3 ff ff       	jmp    801065ff <alltraps>
...
80107269:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010726e:	e9 8c f3 ff ff       	jmp    801065ff <alltraps>
...
80107275:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010727a:	e9 80 f3 ff ff       	jmp    801065ff <alltraps>
...
80107281:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107286:	e9 74 f3 ff ff       	jmp    801065ff <alltraps>
...
8010728d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107292:	e9 68 f3 ff ff       	jmp    801065ff <alltraps>
...
80107299:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010729e:	e9 5c f3 ff ff       	jmp    801065ff <alltraps>
...
801072a5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801072aa:	e9 50 f3 ff ff       	jmp    801065ff <alltraps>
...
801072b1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801072b6:	e9 44 f3 ff ff       	jmp    801065ff <alltraps>
...
801072bd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801072c2:	e9 38 f3 ff ff       	jmp    801065ff <alltraps>
...
801072c9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801072ce:	e9 2c f3 ff ff       	jmp    801065ff <alltraps>
...
801072d5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801072da:	e9 20 f3 ff ff       	jmp    801065ff <alltraps>
...
801072e1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801072e6:	e9 14 f3 ff ff       	jmp    801065ff <alltraps>
...
801072ed:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801072f2:	e9 08 f3 ff ff       	jmp    801065ff <alltraps>
...
801072f9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801072fe:	e9 fc f2 ff ff       	jmp    801065ff <alltraps>
...
80107305:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010730a:	e9 f0 f2 ff ff       	jmp    801065ff <alltraps>
...
80107311:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107316:	e9 e4 f2 ff ff       	jmp    801065ff <alltraps>
...
8010731d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107322:	e9 d8 f2 ff ff       	jmp    801065ff <alltraps>
...
80107329:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010732e:	e9 cc f2 ff ff       	jmp    801065ff <alltraps>
...
80107335:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010733a:	e9 c0 f2 ff ff       	jmp    801065ff <alltraps>
...
80107341:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107346:	e9 b4 f2 ff ff       	jmp    801065ff <alltraps>
...
8010734d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107352:	e9 a8 f2 ff ff       	jmp    801065ff <alltraps>
...
80107359:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010735e:	e9 9c f2 ff ff       	jmp    801065ff <alltraps>
...
80107365:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010736a:	e9 90 f2 ff ff       	jmp    801065ff <alltraps>
...
80107371:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107376:	e9 84 f2 ff ff       	jmp    801065ff <alltraps>
...
8010737d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107382:	e9 78 f2 ff ff       	jmp    801065ff <alltraps>
...
80107389:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010738e:	e9 6c f2 ff ff       	jmp    801065ff <alltraps>
...
80107395:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010739a:	e9 60 f2 ff ff       	jmp    801065ff <alltraps>
...
801073a1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801073a6:	e9 54 f2 ff ff       	jmp    801065ff <alltraps>
...
801073ad:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801073b2:	e9 48 f2 ff ff       	jmp    801065ff <alltraps>
...
801073b9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801073be:	e9 3c f2 ff ff       	jmp    801065ff <alltraps>
...
801073c5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801073ca:	e9 30 f2 ff ff       	jmp    801065ff <alltraps>
...
801073d1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801073d6:	e9 24 f2 ff ff       	jmp    801065ff <alltraps>
...
801073dd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801073e2:	e9 18 f2 ff ff       	jmp    801065ff <alltraps>
...
801073e9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801073ee:	e9 0c f2 ff ff       	jmp    801065ff <alltraps>
...
801073f5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801073fa:	e9 00 f2 ff ff       	jmp    801065ff <alltraps>
...
80107401:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107406:	e9 f4 f1 ff ff       	jmp    801065ff <alltraps>
...
8010740d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107412:	e9 e8 f1 ff ff       	jmp    801065ff <alltraps>
...
80107419:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010741e:	e9 dc f1 ff ff       	jmp    801065ff <alltraps>
...
80107425:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010742a:	e9 d0 f1 ff ff       	jmp    801065ff <alltraps>
...
80107431:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107436:	e9 c4 f1 ff ff       	jmp    801065ff <alltraps>
...
8010743d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107442:	e9 b8 f1 ff ff       	jmp    801065ff <alltraps>
...
80107449:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010744e:	e9 ac f1 ff ff       	jmp    801065ff <alltraps>
...
80107455:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010745a:	e9 a0 f1 ff ff       	jmp    801065ff <alltraps>
...
80107461:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107466:	e9 94 f1 ff ff       	jmp    801065ff <alltraps>
...
8010746d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107472:	e9 88 f1 ff ff       	jmp    801065ff <alltraps>
...
80107479:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010747e:	e9 7c f1 ff ff       	jmp    801065ff <alltraps>
...
80107485:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010748a:	e9 70 f1 ff ff       	jmp    801065ff <alltraps>
...
80107491:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107496:	e9 64 f1 ff ff       	jmp    801065ff <alltraps>
...
8010749d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801074a2:	e9 58 f1 ff ff       	jmp    801065ff <alltraps>
...
801074a9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801074ae:	e9 4c f1 ff ff       	jmp    801065ff <alltraps>
...
801074b5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801074ba:	e9 40 f1 ff ff       	jmp    801065ff <alltraps>
...
801074c1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801074c6:	e9 34 f1 ff ff       	jmp    801065ff <alltraps>
...
801074cd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801074d2:	e9 28 f1 ff ff       	jmp    801065ff <alltraps>
...
801074d9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801074de:	e9 1c f1 ff ff       	jmp    801065ff <alltraps>
...
801074e5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801074ea:	e9 10 f1 ff ff       	jmp    801065ff <alltraps>
...
801074f1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801074f6:	e9 04 f1 ff ff       	jmp    801065ff <alltraps>
...
801074fd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107502:	e9 f8 f0 ff ff       	jmp    801065ff <alltraps>
...
80107509:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010750e:	e9 ec f0 ff ff       	jmp    801065ff <alltraps>
...
80107515:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010751a:	e9 e0 f0 ff ff       	jmp    801065ff <alltraps>
...
80107521:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107526:	e9 d4 f0 ff ff       	jmp    801065ff <alltraps>
...
80107535:	89 d6                	mov    %edx,%esi
    pde_t* pde;
    pte_t* pgtab;

    pde = &pgdir[PDX(va)];
80107537:	c1 ea 16             	shr    $0x16,%edx
walkpgdir(pde_t* pgdir, const void* va, int alloc) {
8010753a:	53                   	push   %ebx
    pde = &pgdir[PDX(va)];
8010753b:	8d 3c 90             	lea    (%eax,%edx,4),%edi
walkpgdir(pde_t* pgdir, const void* va, int alloc) {
8010753e:	83 ec 0c             	sub    $0xc,%esp
    if (*pde & PTE_P) {
80107541:	8b 1f                	mov    (%edi),%ebx
80107543:	f6 c3 01             	test   $0x1,%bl
80107546:	74 28                	je     80107570 <walkpgdir+0x40>
        pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107548:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010754e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
    ...
    return &pgtab[PTX(va)];
80107554:	89 f0                	mov    %esi,%eax
}
80107556:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return &pgtab[PTX(va)];
80107559:	c1 e8 0a             	shr    $0xa,%eax
8010755c:	25 fc 0f 00 00       	and    $0xffc,%eax
80107561:	01 d8                	add    %ebx,%eax
}
80107563:	5b                   	pop    %ebx
80107564:	5e                   	pop    %esi
80107565:	5f                   	pop    %edi
...
80107572:	74 2c                	je     801075a0 <walkpgdir+0x70>
80107574:	e8 57 bc ff ff       	call   801031d0 <kalloc>
80107579:	89 c3                	mov    %eax,%ebx
8010757b:	85 c0                	test   %eax,%eax
8010757d:	74 21                	je     801075a0 <walkpgdir+0x70>
        memset(pgtab, 0, PGSIZE);
8010757f:	83 ec 04             	sub    $0x4,%esp
80107582:	68 00 10 00 00       	push   $0x1000
80107587:	6a 00                	push   $0x0
80107589:	50                   	push   %eax
8010758a:	e8 71 dd ff ff       	call   80105300 <memset>
        *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010758f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107595:	83 c4 10             	add    $0x10,%esp
80107598:	83 c8 07             	or     $0x7,%eax
8010759b:	89 07                	mov    %eax,(%edi)
8010759d:	eb b5                	jmp    80107554 <walkpgdir+0x24>
8010759f:	90                   	nop
}
...
801075b4:	89 c7                	mov    %eax,%edi
    char *a, *last;
    pte_t* pte;

    a = (char*)PGROUNDDOWN((uint)va);
    last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801075b6:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
mappages(pde_t* pgdir, void* va, uint size, uint pa, int perm) {
801075ba:	56                   	push   %esi
    last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801075bb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    a = (char*)PGROUNDDOWN((uint)va);
801075c0:	89 d6                	mov    %edx,%esi
mappages(pde_t* pgdir, void* va, uint size, uint pa, int perm) {
801075c2:	53                   	push   %ebx
    a = (char*)PGROUNDDOWN((uint)va);
801075c3:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
mappages(pde_t* pgdir, void* va, uint size, uint pa, int perm) {
801075c9:	83 ec 1c             	sub    $0x1c,%esp
    last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801075cc:	89 45 e0             	mov    %eax,-0x20(%ebp)
801075cf:	8b 45 08             	mov    0x8(%ebp),%eax
801075d2:	29 f0                	sub    %esi,%eax
801075d4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801075d7:	eb 1f                	jmp    801075f8 <mappages+0x48>
801075d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for (;;) {
        if ((pte = walkpgdir(pgdir, a, 1)) == 0)
            return -1;
        if (*pte & PTE_P)
801075e0:	f6 00 01             	testb  $0x1,(%eax)
801075e3:	75 45                	jne    8010762a <mappages+0x7a>
            panic("remap");
        *pte = pa | perm | PTE_P;
801075e5:	0b 5d 0c             	or     0xc(%ebp),%ebx
801075e8:	83 cb 01             	or     $0x1,%ebx
801075eb:	89 18                	mov    %ebx,(%eax)
        if (a == last)
801075ed:	3b 75 e0             	cmp    -0x20(%ebp),%esi
801075f0:	74 2e                	je     80107620 <mappages+0x70>
            break;
        a += PGSIZE;
801075f2:	81 c6 00 10 00 00    	add    $0x1000,%esi
    for (;;) {
801075f8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
        if ((pte = walkpgdir(pgdir, a, 1)) == 0)
801075fb:	b9 01 00 00 00       	mov    $0x1,%ecx
80107600:	89 f2                	mov    %esi,%edx
80107602:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80107605:	89 f8                	mov    %edi,%eax
80107607:	e8 24 ff ff ff       	call   80107530 <walkpgdir>
8010760c:	85 c0                	test   %eax,%eax
8010760e:	75 d0                	jne    801075e0 <mappages+0x30>
        pa += PGSIZE;
    }
    return 0;
}
80107610:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return -1;
80107613:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107618:	5b                   	pop    %ebx
80107619:	5e                   	pop    %esi
8010761a:	5f                   	pop    %edi
...
8010762d:	68 18 88 10 80       	push   $0x80108818
80107632:	e8 59 8d ff ff       	call   80100390 <panic>
...
80107645:	89 c6                	mov    %eax,%esi
80107647:	53                   	push   %ebx
80107648:	89 d3                	mov    %edx,%ebx
    uint a, pa;
    ...
    a = PGROUNDUP(newsz);
8010764a:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80107650:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
int deallocuvm(pde_t* pgdir, uint oldsz, uint newsz) {
80107656:	83 ec 1c             	sub    $0x1c,%esp
80107659:	89 4d e0             	mov    %ecx,-0x20(%ebp)
    for (; a < oldsz; a += PGSIZE) {
8010765c:	39 da                	cmp    %ebx,%edx
8010765e:	73 5b                	jae    801076bb <deallocuvm.part.0+0x7b>
80107660:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80107663:	89 d7                	mov    %edx,%edi
80107665:	eb 14                	jmp    8010767b <deallocuvm.part.0+0x3b>
80107667:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010766e:	66 90                	xchg   %ax,%ax
80107670:	81 c7 00 10 00 00    	add    $0x1000,%edi
80107676:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80107679:	76 40                	jbe    801076bb <deallocuvm.part.0+0x7b>
        pte = walkpgdir(pgdir, (char*)a, 0);
8010767b:	31 c9                	xor    %ecx,%ecx
8010767d:	89 fa                	mov    %edi,%edx
8010767f:	89 f0                	mov    %esi,%eax
80107681:	e8 aa fe ff ff       	call   80107530 <walkpgdir>
80107686:	89 c3                	mov    %eax,%ebx
        if (!pte)
80107688:	85 c0                	test   %eax,%eax
8010768a:	74 44                	je     801076d0 <deallocuvm.part.0+0x90>
            a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
        else if ((*pte & PTE_P) != 0) {
8010768c:	8b 00                	mov    (%eax),%eax
8010768e:	a8 01                	test   $0x1,%al
80107690:	74 de                	je     80107670 <deallocuvm.part.0+0x30>
            pa = PTE_ADDR(*pte);
            if (pa == 0)
80107692:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107697:	74 47                	je     801076e0 <deallocuvm.part.0+0xa0>
                panic("kfree");
            char* v = P2V(pa);
            kfree(v);
80107699:	83 ec 0c             	sub    $0xc,%esp
            char* v = P2V(pa);
8010769c:	05 00 00 00 80       	add    $0x80000000,%eax
801076a1:	81 c7 00 10 00 00    	add    $0x1000,%edi
            kfree(v);
801076a7:	50                   	push   %eax
801076a8:	e8 63 b9 ff ff       	call   80103010 <kfree>
            *pte = 0;
801076ad:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
801076b3:	83 c4 10             	add    $0x10,%esp
    for (; a < oldsz; a += PGSIZE) {
801076b6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
801076b9:	77 c0                	ja     8010767b <deallocuvm.part.0+0x3b>
        }
    }
    return newsz;
}
801076bb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801076be:	8d 65 f4             	lea    -0xc(%ebp),%esp
801076c1:	5b                   	pop    %ebx
801076c2:	5e                   	pop    %esi
801076c3:	5f                   	pop    %edi
801076c4:	5d                   	pop    %ebp
...
801076d2:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
801076d8:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
801076de:	eb 96                	jmp    80107676 <deallocuvm.part.0+0x36>
                panic("kfree");
801076e0:	83 ec 0c             	sub    $0xc,%esp
801076e3:	68 3e 81 10 80       	push   $0x8010813e
...
801076f7:	83 ec 18             	sub    $0x18,%esp
    c = &cpus[cpuid()];
801076fa:	e8 e1 cd ff ff       	call   801044e0 <cpuid>
    pd[0] = size - 1;
801076ff:	ba 2f 00 00 00       	mov    $0x2f,%edx
80107704:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
8010770a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
    c->gdt[SEG_KCODE] = SEG(STA_X | STA_R, 0, 0xffffffff, 0);
8010770e:	c7 80 98 3d 11 80 ff 	movl   $0xffff,-0x7feec268(%eax)
80107715:	ff 00 00 
80107718:	c7 80 9c 3d 11 80 00 	movl   $0xcf9a00,-0x7feec264(%eax)
8010771f:	9a cf 00 
    c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107722:	c7 80 a0 3d 11 80 ff 	movl   $0xffff,-0x7feec260(%eax)
80107729:	ff 00 00 
8010772c:	c7 80 a4 3d 11 80 00 	movl   $0xcf9200,-0x7feec25c(%eax)
80107733:	92 cf 00 
    c->gdt[SEG_UCODE] = SEG(STA_X | STA_R, 0, 0xffffffff, DPL_USER);
80107736:	c7 80 a8 3d 11 80 ff 	movl   $0xffff,-0x7feec258(%eax)
8010773d:	ff 00 00 
80107740:	c7 80 ac 3d 11 80 00 	movl   $0xcffa00,-0x7feec254(%eax)
80107747:	fa cf 00 
    c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010774a:	c7 80 b0 3d 11 80 ff 	movl   $0xffff,-0x7feec250(%eax)
80107751:	ff 00 00 
80107754:	c7 80 b4 3d 11 80 00 	movl   $0xcff200,-0x7feec24c(%eax)
8010775b:	f2 cf 00 
    lgdt(c->gdt, sizeof(c->gdt));
8010775e:	05 90 3d 11 80       	add    $0x80113d90,%eax
    pd[1] = (uint)p;
80107763:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
    pd[2] = (uint)p >> 16;
80107767:	c1 e8 10             	shr    $0x10,%eax
8010776a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
    asm volatile("lgdt (%0)"
8010776e:	8d 45 f2             	lea    -0xe(%ebp),%eax
80107771:	0f 01 10             	lgdtl  (%eax)
}
80107774:	c9                   	leave  
80107775:	c3                   	ret    
...
80107784:	a1 44 6b 11 80       	mov    0x80116b44,%eax
...
801077ad:	8b 75 08             	mov    0x8(%ebp),%esi
    if (p == 0)
801077b0:	85 f6                	test   %esi,%esi
801077b2:	0f 84 cb 00 00 00    	je     80107883 <switchuvm+0xe3>
    if (p->kstack == 0)
801077b8:	8b 46 08             	mov    0x8(%esi),%eax
801077bb:	85 c0                	test   %eax,%eax
801077bd:	0f 84 da 00 00 00    	je     8010789d <switchuvm+0xfd>
    if (p->pgdir == 0)
801077c3:	8b 46 04             	mov    0x4(%esi),%eax
801077c6:	85 c0                	test   %eax,%eax
801077c8:	0f 84 c2 00 00 00    	je     80107890 <switchuvm+0xf0>
    pushcli();
801077ce:	e8 1d d9 ff ff       	call   801050f0 <pushcli>
    mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801077d3:	e8 98 cc ff ff       	call   80104470 <mycpu>
801077d8:	89 c3                	mov    %eax,%ebx
801077da:	e8 91 cc ff ff       	call   80104470 <mycpu>
801077df:	89 c7                	mov    %eax,%edi
801077e1:	e8 8a cc ff ff       	call   80104470 <mycpu>
801077e6:	83 c7 08             	add    $0x8,%edi
801077e9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801077ec:	e8 7f cc ff ff       	call   80104470 <mycpu>
801077f1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801077f4:	ba 67 00 00 00       	mov    $0x67,%edx
801077f9:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107800:	83 c0 08             	add    $0x8,%eax
80107803:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
    mycpu()->ts.iomb = (ushort)0xFFFF;
8010780a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010780f:	83 c1 08             	add    $0x8,%ecx
80107812:	c1 e8 18             	shr    $0x18,%eax
80107815:	c1 e9 10             	shr    $0x10,%ecx
80107818:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
8010781e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107824:	b9 99 40 00 00       	mov    $0x4099,%ecx
80107829:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
    mycpu()->ts.ss0 = SEG_KDATA << 3;
80107830:	bb 10 00 00 00       	mov    $0x10,%ebx
    mycpu()->gdt[SEG_TSS].s = 0;
80107835:	e8 36 cc ff ff       	call   80104470 <mycpu>
8010783a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
    mycpu()->ts.ss0 = SEG_KDATA << 3;
80107841:	e8 2a cc ff ff       	call   80104470 <mycpu>
80107846:	66 89 58 10          	mov    %bx,0x10(%eax)
    mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
8010784a:	8b 5e 08             	mov    0x8(%esi),%ebx
8010784d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107853:	e8 18 cc ff ff       	call   80104470 <mycpu>
80107858:	89 58 0c             	mov    %ebx,0xc(%eax)
    mycpu()->ts.iomb = (ushort)0xFFFF;
8010785b:	e8 10 cc ff ff       	call   80104470 <mycpu>
80107860:	66 89 78 6e          	mov    %di,0x6e(%eax)
    asm volatile("ltr %0"
80107864:	b8 28 00 00 00       	mov    $0x28,%eax
80107869:	0f 00 d8             	ltr    %ax
    lcr3(V2P(p->pgdir)); // switch to process's address space
8010786c:	8b 46 04             	mov    0x4(%esi),%eax
8010786f:	05 00 00 00 80       	add    $0x80000000,%eax
    asm volatile("movl %0,%%cr3"
80107874:	0f 22 d8             	mov    %eax,%cr3
}
...
801078bd:	8b 45 0c             	mov    0xc(%ebp),%eax
801078c0:	8b 75 10             	mov    0x10(%ebp),%esi
801078c3:	8b 7d 08             	mov    0x8(%ebp),%edi
801078c6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if (sz >= PGSIZE)
801078c9:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801078cf:	77 4b                	ja     8010791c <inituvm+0x6c>
    mem = kalloc();
801078d1:	e8 fa b8 ff ff       	call   801031d0 <kalloc>
    memset(mem, 0, PGSIZE);
...
801078e2:	50                   	push   %eax
801078e3:	e8 18 da ff ff       	call   80105300 <memset>
    mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W | PTE_U);
801078e8:	58                   	pop    %eax
801078e9:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801078ef:	5a                   	pop    %edx
801078f0:	6a 06                	push   $0x6
801078f2:	b9 00 10 00 00       	mov    $0x1000,%ecx
801078f7:	31 d2                	xor    %edx,%edx
801078f9:	50                   	push   %eax
801078fa:	89 f8                	mov    %edi,%eax
801078fc:	e8 af fc ff ff       	call   801075b0 <mappages>
    memmove(mem, init, sz);
80107901:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107904:	89 75 10             	mov    %esi,0x10(%ebp)
80107907:	83 c4 10             	add    $0x10,%esp
8010790a:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010790d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80107916:	5d                   	pop    %ebp
    memmove(mem, init, sz);
80107917:	e9 84 da ff ff       	jmp    801053a0 <memmove>
        panic("inituvm: more than a page");
8010791c:	83 ec 0c             	sub    $0xc,%esp
8010791f:	68 5d 88 10 80       	push   $0x8010885d
...
80107940:	8b 75 18             	mov    0x18(%ebp),%esi
    if ((uint)addr % PGSIZE != 0)
80107943:	a9 ff 0f 00 00       	test   $0xfff,%eax
80107948:	0f 85 99 00 00 00    	jne    801079e7 <loaduvm+0xb7>
    for (i = 0; i < sz; i += PGSIZE) {
8010794e:	01 f0                	add    %esi,%eax
80107950:	89 f3                	mov    %esi,%ebx
80107952:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if (readi(ip, P2V(pa), offset + i, n) != n)
80107955:	8b 45 14             	mov    0x14(%ebp),%eax
80107958:	01 f0                	add    %esi,%eax
8010795a:	89 45 e0             	mov    %eax,-0x20(%ebp)
    for (i = 0; i < sz; i += PGSIZE) {
8010795d:	85 f6                	test   %esi,%esi
8010795f:	75 15                	jne    80107976 <loaduvm+0x46>
80107961:	eb 6d                	jmp    801079d0 <loaduvm+0xa0>
80107963:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107967:	90                   	nop
80107968:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
8010796e:	89 f0                	mov    %esi,%eax
80107970:	29 d8                	sub    %ebx,%eax
80107972:	39 c6                	cmp    %eax,%esi
80107974:	76 5a                	jbe    801079d0 <loaduvm+0xa0>
        if ((pte = walkpgdir(pgdir, addr + i, 0)) == 0)
80107976:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107979:	8b 45 08             	mov    0x8(%ebp),%eax
8010797c:	31 c9                	xor    %ecx,%ecx
8010797e:	29 da                	sub    %ebx,%edx
80107980:	e8 ab fb ff ff       	call   80107530 <walkpgdir>
80107985:	85 c0                	test   %eax,%eax
80107987:	74 51                	je     801079da <loaduvm+0xaa>
        pa = PTE_ADDR(*pte);
...
801079ab:	ff 75 10             	pushl  0x10(%ebp)
801079ae:	e8 4d ac ff ff       	call   80102600 <readi>
801079b3:	83 c4 10             	add    $0x10,%esp
801079b6:	39 f8                	cmp    %edi,%eax
801079b8:	74 ae                	je     80107968 <loaduvm+0x38>
}
...
801079dd:	68 77 88 10 80       	push   $0x80108877
801079e2:	e8 a9 89 ff ff       	call   80100390 <panic>
        panic("loaduvm: addr must be page aligned");
801079e7:	83 ec 0c             	sub    $0xc,%esp
801079ea:	68 18 89 10 80       	push   $0x80108918
801079ef:	e8 9c 89 ff ff       	call   80100390 <panic>
801079f4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107a4b:	e8 b0 d8 ff ff       	call   80105300 <memset>
...
80107a64:	e8 47 fb ff ff       	call   801075b0 <mappages>
...
80107a79:	76 48                	jbe    80107ac3 <allocuvm+0xc3>
        mem = kalloc();
80107a7b:	e8 50 b7 ff ff       	call   801031d0 <kalloc>
...
80107a89:	68 95 88 10 80       	push   $0x80108895
80107a8e:	e8 2d 8d ff ff       	call   801007c0 <cprintf>
    if (newsz >= oldsz)
...
80107aa5:	e8 96 fb ff ff       	call   80107640 <deallocuvm.part.0>
            return 0;
...
80107aeb:	68 ad 88 10 80       	push   $0x801088ad
80107af0:	e8 cb 8c ff ff       	call   801007c0 <cprintf>
    if (newsz >= oldsz)
...
80107b07:	e8 34 fb ff ff       	call   80107640 <deallocuvm.part.0>
            kfree(mem);
80107b0c:	83 ec 0c             	sub    $0xc,%esp
80107b0f:	53                   	push   %ebx
80107b10:	e8 fb b4 ff ff       	call   80103010 <kfree>
            return 0;
...
80107b44:	5d                   	pop    %ebp
80107b45:	e9 f6 fa ff ff       	jmp    80107640 <deallocuvm.part.0>
...
80107b7f:	e8 bc fa ff ff       	call   80107640 <deallocuvm.part.0>
...
80107bae:	e8 5d b4 ff ff       	call   80103010 <kfree>
...
80107bc3:	5d                   	pop    %ebp
    kfree((char*)pgdir);
80107bc4:	e9 47 b4 ff ff       	jmp    80103010 <kfree>
        panic("freevm: no pgdir");
80107bc9:	83 ec 0c             	sub    $0xc,%esp
80107bcc:	68 c9 88 10 80       	push   $0x801088c9
...
80107be9:	e8 e2 b5 ff ff       	call   801031d0 <kalloc>
...
80107c04:	e8 f7 d6 ff ff       	call   80105300 <memset>
...
80107c6f:	a3 44 6b 11 80       	mov    %eax,0x80116b44
    lcr3(V2P(kpgdir)); // switch to the kernel page table
...
80107c92:	e8 99 f8 ff ff       	call   80107530 <walkpgdir>
    if (pte == 0)
80107c97:	85 c0                	test   %eax,%eax
80107c99:	74 05                	je     80107ca0 <clearpteu+0x20>
        panic("clearpteu");
    *pte &= ~PTE_U;
80107c9b:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80107c9e:	c9                   	leave  
80107c9f:	c3                   	ret    
        panic("clearpteu");
80107ca0:	83 ec 0c             	sub    $0xc,%esp
80107ca3:	68 da 88 10 80       	push   $0x801088da
...
80107cb8:	56                   	push   %esi
80107cb9:	53                   	push   %ebx
80107cba:	83 ec 1c             	sub    $0x1c,%esp
    pde_t* d;
    pte_t* pte;
    uint pa, i, flags;
    char* mem;
    ...
    if ((d = setupkvm()) == 0)
80107cbd:	e8 1e ff ff ff       	call   80107be0 <setupkvm>
80107cc2:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107cc5:	85 c0                	test   %eax,%eax
80107cc7:	0f 84 9b 00 00 00    	je     80107d68 <copyuvm+0xb8>
        return 0;
    for (i = 0; i < sz; i += PGSIZE) {
80107ccd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107cd0:	85 c9                	test   %ecx,%ecx
80107cd2:	0f 84 90 00 00 00    	je     80107d68 <copyuvm+0xb8>
80107cd8:	31 f6                	xor    %esi,%esi
80107cda:	eb 46                	jmp    80107d22 <copyuvm+0x72>
...
80107cf0:	e8 ab d6 ff ff       	call   801053a0 <memmove>
...
80107d0b:	e8 a0 f8 ff ff       	call   801075b0 <mappages>
80107d10:	83 c4 10             	add    $0x10,%esp
80107d13:	85 c0                	test   %eax,%eax
80107d15:	78 61                	js     80107d78 <copyuvm+0xc8>
    for (i = 0; i < sz; i += PGSIZE) {
80107d17:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107d1d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107d20:	76 46                	jbe    80107d68 <copyuvm+0xb8>
        if ((pte = walkpgdir(pgdir, (void*)i, 0)) == 0)
80107d22:	8b 45 08             	mov    0x8(%ebp),%eax
80107d25:	31 c9                	xor    %ecx,%ecx
80107d27:	89 f2                	mov    %esi,%edx
80107d29:	e8 02 f8 ff ff       	call   80107530 <walkpgdir>
80107d2e:	85 c0                	test   %eax,%eax
80107d30:	74 61                	je     80107d93 <copyuvm+0xe3>
        if (!(*pte & PTE_P))
80107d32:	8b 00                	mov    (%eax),%eax
80107d34:	a8 01                	test   $0x1,%al
80107d36:	74 4e                	je     80107d86 <copyuvm+0xd6>
        pa = PTE_ADDR(*pte);
80107d38:	89 c7                	mov    %eax,%edi
        flags = PTE_FLAGS(*pte);
80107d3a:	25 ff 0f 00 00       	and    $0xfff,%eax
80107d3f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        pa = PTE_ADDR(*pte);
80107d42:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
        if ((mem = kalloc()) == 0)
80107d48:	e8 83 b4 ff ff       	call   801031d0 <kalloc>
80107d4d:	89 c3                	mov    %eax,%ebx
80107d4f:	85 c0                	test   %eax,%eax
80107d51:	75 8d                	jne    80107ce0 <copyuvm+0x30>
        }
    }
    return d;
...
80107d56:	ff 75 e0             	pushl  -0x20(%ebp)
80107d59:	e8 02 fe ff ff       	call   80107b60 <freevm>
    return 0;
80107d5e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
80107d65:	83 c4 10             	add    $0x10,%esp
}
80107d68:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107d6b:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107d6e:	5b                   	pop    %ebx
80107d6f:	5e                   	pop    %esi
80107d70:	5f                   	pop    %edi
80107d71:	5d                   	pop    %ebp
...
80107d7c:	e8 8f b2 ff ff       	call   80103010 <kfree>
            goto bad;
80107d81:	83 c4 10             	add    $0x10,%esp
80107d84:	eb cd                	jmp    80107d53 <copyuvm+0xa3>
            panic("copyuvm: page not present");
80107d86:	83 ec 0c             	sub    $0xc,%esp
80107d89:	68 fe 88 10 80       	push   $0x801088fe
80107d8e:	e8 fd 85 ff ff       	call   80100390 <panic>
            panic("copyuvm: pte should exist");
80107d93:	83 ec 0c             	sub    $0xc,%esp
80107d96:	68 e4 88 10 80       	push   $0x801088e4
80107d9b:	e8 f0 85 ff ff       	call   80100390 <panic>
...
80107db2:	e8 79 f7 ff ff       	call   80107530 <walkpgdir>
    if ((*pte & PTE_P) == 0)
...
80107db9:	c9                   	leave  
    if ((*pte & PTE_U) == 0)
80107dba:	89 c2                	mov    %eax,%edx
    return (char*)P2V(PTE_ADDR(*pte));
80107dbc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if ((*pte & PTE_U) == 0)
80107dc1:	83 e2 05             	and    $0x5,%edx
    return (char*)P2V(PTE_ADDR(*pte));
80107dc4:	05 00 00 00 80       	add    $0x80000000,%eax
80107dc9:	83 fa 05             	cmp    $0x5,%edx
80107dcc:	ba 00 00 00 00       	mov    $0x0,%edx
80107dd1:	0f 45 c2             	cmovne %edx,%eax
}
80107dd4:	c3                   	ret    
80107dd5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107ded:	8b 75 14             	mov    0x14(%ebp),%esi
80107df0:	8b 55 0c             	mov    0xc(%ebp),%edx
    char *buf, *pa0;
    uint n, va0;
...
80107df5:	75 3c                	jne    80107e33 <copyout+0x53>
80107df7:	eb 67                	jmp    80107e60 <copyout+0x80>
80107df9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        ...
        if (pa0 == 0)
            return -1;
        n = PGSIZE - (va - va0);
80107e00:	8b 55 0c             	mov    0xc(%ebp),%edx
80107e03:	89 fb                	mov    %edi,%ebx
80107e05:	29 d3                	sub    %edx,%ebx
80107e07:	81 c3 00 10 00 00    	add    $0x1000,%ebx
        if (n > len)
80107e0d:	39 f3                	cmp    %esi,%ebx
80107e0f:	0f 47 de             	cmova  %esi,%ebx
            n = len;
        memmove(pa0 + (va - va0), buf, n);
80107e12:	29 fa                	sub    %edi,%edx
80107e14:	83 ec 04             	sub    $0x4,%esp
80107e17:	01 c2                	add    %eax,%edx
80107e19:	53                   	push   %ebx
80107e1a:	ff 75 10             	pushl  0x10(%ebp)
80107e1d:	52                   	push   %edx
80107e1e:	e8 7d d5 ff ff       	call   801053a0 <memmove>
        len -= n;
        buf += n;
80107e23:	01 5d 10             	add    %ebx,0x10(%ebp)
        va = va0 + PGSIZE;
80107e26:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
    while (len > 0) {
80107e2c:	83 c4 10             	add    $0x10,%esp
80107e2f:	29 de                	sub    %ebx,%esi
80107e31:	74 2d                	je     80107e60 <copyout+0x80>
        va0 = (uint)PGROUNDDOWN(va);
80107e33:	89 d7                	mov    %edx,%edi
        pa0 = uva2ka(pgdir, (char*)va0);
80107e35:	83 ec 08             	sub    $0x8,%esp
        va0 = (uint)PGROUNDDOWN(va);
80107e38:	89 55 0c             	mov    %edx,0xc(%ebp)
80107e3b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
        pa0 = uva2ka(pgdir, (char*)va0);
80107e41:	57                   	push   %edi
80107e42:	ff 75 08             	pushl  0x8(%ebp)
80107e45:	e8 56 ff ff ff       	call   80107da0 <uva2ka>
        if (pa0 == 0)
80107e4a:	83 c4 10             	add    $0x10,%esp
80107e4d:	85 c0                	test   %eax,%eax
80107e4f:	75 af                	jne    80107e00 <copyout+0x20>
    }
    return 0;
}
80107e51:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return -1;
