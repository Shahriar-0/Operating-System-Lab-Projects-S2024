 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb b3 08 00 00       	mov    $0x8b3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 812:	00 00 00 
    if(p->s.size >= nunits){
