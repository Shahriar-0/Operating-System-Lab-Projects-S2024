...
int main(int argc, char* argv[]) {
  ...
  1d:	51                   	push   %ecx
  1e:	51                   	push   %ecx
  1f:	68 98 07 00 00       	push   $0x798
  24:	6a 02                	push   $0x2
  26:	e8 05 04 00 00       	call   430 <printf>
        exit();
...
void printf(int fd, const char* fmt, ...) {
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
                    s = "(null)";
 5b6:	bb c8 07 00 00       	mov    $0x7c8,%ebx
                while (*s != 0) {
...
void free(void* ap) {
 ...
 605:	a1 78 0a 00 00       	mov    0xa78,%eax
void free(void* ap) {
...
void free(void* ap) {
 ...
 651:	5b                   	pop    %ebx
    freep = p;
 652:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
void* malloc(uint nbytes) {
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6a0:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6e9:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
    return freep;
 717:	a1 78 0a 00 00       	mov    0xa78,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
            freep = prevp;
 747:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 ...
 75e:	66 90                	xchg   %ax,%ax
        base.s.ptr = freep = prevp = &base;
 760:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 767:	0a 00 00 
        base.s.size = 0;
 76a:	bf 7c 0a 00 00       	mov    $0xa7c,%edi
        base.s.ptr = freep = prevp = &base;
 76f:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 776:	0a 00 00 
    for (p = prevp->s.ptr;; prevp = p, p = p->s.ptr) {
 779:	89 f8                	mov    %edi,%eax
        base.s.size = 0;
 77b:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 782:	00 00 00 
        if (p->s.size >= nunits) {
