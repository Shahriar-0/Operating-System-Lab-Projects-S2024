...
_droot_test:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  41:	89 c3                	mov    %eax,%ebx
    ...
    int result = droot();
  43:	e8 33 03 00 00       	call   37b <droot>
    asm volatile (
  48:	89 f3                	mov    %esi,%ebx
        "movl %0, %%ebx;"
        : : "r"(prev_ebx)
    );
...
printint(int fd, int xx, int base, int sgn) {
 ...
 3c9:	0f b6 92 ec 07 00 00 	movzbl 0x7ec(%edx),%edx
...
void printf(int fd, const char* fmt, ...) {
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
                    s = "(null)";
 5c6:	bb e4 07 00 00       	mov    $0x7e4,%ebx
                while (*s != 0) {
